...
if(!empty($_GET['classlevel']) && $_GET['classlevel']>0){ //คำนำหน้าชื่อ
	$arrWhere[]= 'a.classlevelid='.$_GET['classlevel'];
...
$query_group = "SELECT a.*,b.*,c.*,d.* FROM tbl_group as a   left join tbl_classlevel as b on a.classlevelid=b.classlevelid  left join tbl_teacher as c on a.TeacherID=c.TeacherID left join tbl_prefix as d on c.PrefixCode=d.PrefixCode WHERE (a.classlevelid = b.classlevelid or b.classlevelid is null) and (a.TeacherID=c.TeacherID or c.TeacherID is null) and (c.PrefixCode=d.PrefixCode or d.PrefixCode is null) ".$strSQLWhere." ";
...
<div class="container">
   ...
   <form action="search.php" method="get" id="search">
    ...
    <div class="col-sm-3"><select name="classlevel" id="classlevel" class="form-control">
      <option value=""  <?php if (!(strcmp("", $row_classlevel['classlevelid']))) {echo "selected=\"selected\"";} ?>>คำนำหน้าชื่อ</option>
      <?php
do {  
?>
      <option value="<?php echo $row_classlevel['classlevelid']?>"<?php if (!(strcmp($row_classlevel['classlevelid'], $row_classlevel['classlevelid']))) {echo "selected=\"selected\"";} ?>><?php echo $row_classlevel['classlevelname']?></option>
      <?php
...
?>
 ...
 <div class="col-sm-12"><br></div>
  ...
  <input name="search" type="submit" id="search" value="ค้นหา" class="btn btn-success">
   ...
   จำนวน  <strong style="color:#000DFF;"><?php echo $totalRows_group ?></strong> ห้อง 
</div>
