...
if ((isset($_GET['AcademicYearsID'])) && ($_GET['AcademicYearsID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM tbl_academicyears WHERE AcademicYearsID=%s",
                       GetSQLValueString($_GET['AcademicYearsID'], "int"));
