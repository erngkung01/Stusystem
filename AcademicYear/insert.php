...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "insertacademicyear")) {
  $insertSQL = sprintf("INSERT INTO tbl_academicyears (AcademicYears) VALUES (%s)",
...
<form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="insertacademicyear" id="insertacademicyear">
<div class="container">
 ...
 <h2 style="text-align:center;">เพิ่มข้อมูลปีการศึกษา</h2>
  ...
  <table class="table table-condensed">
    ...
    <tbody>
      <tr>
        <td>ปีการศึกษา</td>
        <td><input name="AcademicYears" type="number" id="AcademicYears" class="form-control"></td>
      </tr>
     
     <tr>
      <td colspan="2" style="text-align:center;"><input name="inserstudentdata" type="submit" id="inserstudentdata" value="เพิ่มข้อมูลปีการศึกษา" class="btn btn-success" ></td>
        </tr>
    </tbody>
  </table>
</div>
<input type="hidden" name="MM_insert" value="insertteacherdata">
<input type="hidden" name="MM_insert" value="insertacademicyear">
</form>
