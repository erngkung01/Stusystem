...
CREATE TABLE `tbl_academicyears` (
  `AcademicYearsID` int(5) NOT NULL,
  `AcademicYears` int(4) NOT NULL
...
INSERT INTO `tbl_academicyears` (`AcademicYearsID`, `AcademicYears`) VALUES
(1, 2561),
(2, 2560),
(4, 2558),
(5, 2559),
...
--
-- Table structure for table `tbl_academicyearstype`
--

CREATE TABLE `tbl_academicyearstype` (
  `AcademicYearstypeid` int(2) NOT NULL,
  `AcademicYearstypename` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tbl_academicyearstype`
--

INSERT INTO `tbl_academicyearstype` (`AcademicYearstypeid`, `AcademicYearstypename`) VALUES
(1, 'ปีการศึกษาปัจจุบัน'),
(2, 'ปีการศึกษาผ่านมาแล้ว');
...
CREATE TABLE `tbl_award` (
  ...
  `AwardYear` int(4) NOT NULL,
  `AwardSemester` int(5) NOT NULL,
  `AwardName` char(120) NOT NULL,
  `AwardDetail` varchar(150) DEFAULT NULL,
  `AwardPic` varchar(255) DEFAULT NULL,
  `AwardDate` date NOT NULL,
  `AwardBy` char(80) NOT NULL,
  `studentID` varchar(8) NOT NULL,
  `AwardTypeID` int(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tbl_award` (`AwardID`, `AwardYear`, `AwardSemester`, `AwardName`, `AwardDetail`, `AwardPic`, `AwardDate`, `AwardBy`, `studentID`, `AwardTypeID`) VALUES
(15, 2, 1, '2222222222', '<p>111111</p>\r\n', '84920-1.jpg', '0000-00-00', '6666', '4141', 1),
(16, 1, 1, '555', '<p>5555555555555</p>\r\n', '18076868_1438135796208548_3876717737359273463_o.jpg', '2018-08-15', '1111111111111', '4141', 2),
(17, 2, 1, '11', '<p>111111</p>\r\n', '11949470_929000247165369_932249585669344706_n.jpg', '2018-08-20', '555', '11111111', 1),
(21, 1, 1, '1111', '<p><img alt=\"\" src=\"upload/files/1534695561_18056898_1438135599541901_4846138602896472409_n.jpg\" style=\"height:500px; width:500px\" /></p>\r\n', '84920-1.jpg', '2018-07-30', '6666', '111111', 1),
(22, 1, 1, '1', '<p>1</p>\r\n', '93862l.jpg', '2019-01-08', '1', '9973', 1);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_awardtype`
--

CREATE TABLE `tbl_awardtype` (
  `AwardTypeID` int(5) NOT NULL,
  `AwardTypeName` varchar(80) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tbl_awardtype`
--

INSERT INTO `tbl_awardtype` (`AwardTypeID`, `AwardTypeName`) VALUES
(1, 'ผลงาน'),
(2, 'รางวัล');
...
--
-- Table structure for table `tbl_blger`
--

CREATE TABLE `tbl_blger` (
  `blgerid` int(2) NOT NULL,
  `blgerName` varchar(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tbl_blger`
--

INSERT INTO `tbl_blger` (`blgerid`, `blgerName`) VALUES
(1, 'A'),
(2, 'B'),
(3, 'AB'),
(4, 'O');
...
--
-- Table structure for table `tbl_classlevel`
--

CREATE TABLE `tbl_classlevel` (
  `classlevelid` int(2) NOT NULL,
  `classlevelname` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tbl_classlevel`
--

INSERT INTO `tbl_classlevel` (`classlevelid`, `classlevelname`) VALUES
(1, 'อนุบาล 1'),
(2, 'อนุบาล 2'),
(3, 'อนุบาล 3'),
(4, 'ประถมศึกษาปีที่ 1'),
...
CREATE TABLE `tbl_duty` (
  `dutyID` int(5) NOT NULL,
  `dutyyearID` int(5) NOT NULL,
  `TeacherID` varchar(5) NOT NULL,
  `dutyname` varchar(150) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tbl_duty` (`dutyID`, `dutyyearID`, `TeacherID`, `dutyname`) VALUES
(1, 1, '111', '0'),
(2, 1, '111', 'หัวหน้ากีฬาสี2'),
(5, 4, '111', '14114'),
(6, 4, '111', '11111111111'),
(7, 5, '110', 'หัวหน้ากีฬาสี');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_dutyyear`
--

CREATE TABLE `tbl_dutyyear` (
  `dutyyearID` int(5) NOT NULL,
  `AcademicYearsID` int(5) NOT NULL,
  `TeacherID` varchar(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `tbl_dutyyear`
--

INSERT INTO `tbl_dutyyear` (`dutyyearID`, `AcademicYearsID`, `TeacherID`) VALUES
(4, 1, '111'),
(5, 1, '110'),
(6, 1, '5');
...
INSERT INTO `tbl_gender` (`GenderCode`, `GenderName`) VALUES
(1, 'ชาย'),
(2, 'หญิง');
...
INSERT INTO `tbl_group` (`groupid`, `group_name`, `TeacherID`, `classlevelid`) VALUES
('111', 'อ.1/1', '5', 1),
('112', 'อ.1/2', '111', 1),
('121', 'อ.2/1', '111', 2),
('122', 'อ.2/2', '111', 2),
...
CREATE TABLE `tbl_parent` (
  `studentID` varchar(8) NOT NULL,
  `PersonID` varchar(13) NOT NULL,
  `FatherPrefixCode` int(2) NOT NULL,
  `FatherName` varchar(30) NOT NULL,
  `FatherSurName` varchar(30) NOT NULL,
  `FatherPersonID` varchar(13) NOT NULL,
  `Father_tel` varchar(10) NOT NULL,
  `Fatheroccupa` varchar(30) NOT NULL,
  `FatherSalary` varchar(6) NOT NULL,
  `MatherPrefixCode` int(2) NOT NULL,
  `Mathername` varchar(30) NOT NULL,
  `Mathersurname` varchar(30) NOT NULL,
  `MatherPersonID` varchar(13) NOT NULL,
  `Mather_tel` varchar(10) NOT NULL,
  `Matheroccupa` varchar(30) NOT NULL,
  `MatherSalary` varchar(6) NOT NULL,
  `ParentPrefixCode` int(2) NOT NULL,
  `ParentName` varchar(30) NOT NULL,
  `ParentSurname` varchar(30) NOT NULL,
  `ParentPersonID` varchar(13) NOT NULL,
  `Parent_tel` varchar(10) NOT NULL,
  `Parentoccupa` varchar(30) NOT NULL,
  `ParentSalary` varchar(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
('10000', '1609901147363', 3, 'บุญชู', 'บำรุงศรี', '3601000213853', '0', 'ไม่ระบุ', '0', 4, 'นันทนัช', 'บำรุงศรี', '3600300024478', '0', 'ไม่ระบุ', '0', 4, 'นันทนัช', 'บำรุงศรี', '', '0857306799', 'รับราชการ', '0'),
('10002', '1609901138402', 3, 'อานนท์', 'อินประสิทธิ์', '1180200044092', '0', 'ไม่ระบุ', '0', 5, 'กมลวรรณ', 'อินประสิทธิ์', '1619900120674', '0', 'ไม่ระบุ', '0', 5, 'กมลวรรณ', 'อินประสิทธิ์', '', '0971168839', 'แม่บ้าน', '0'),
('10005', '1609901147932', 3, 'นริส', 'บัวเผื่อน', '1609900054906', '0', 'ไม่ระบุ', '0', 5, 'พาณิชย์', 'มีมุข', '1180200011488', '0', 'ไม่ระบุ', '0', 5, 'พาณิชย์', 'มีมุข', '', '0810405724', 'แม่่บ้าน', '0'),
('10006', '1600102134092', 3, 'ศรายุทธ', 'จันทร์อ่อน', '1619900169525', '0', 'ไม่ระบุ', '0', 5, 'อชรายุ', 'นิลสนธิ', '1180200070506', '0', 'ไม่ระบุ', '0', 5, 'อชรายุ', 'นิลสนธิ', '', '0932363411', 'ค้าขาย', '0'),
('10007', '1600102129391', 3, 'ธงชัย', 'พวงสมบัติ', '3601000492001', '0', 'ไม่ระบุ', '0', 5, 'วันทนา', 'บุญนก', '1601000002503', '0', 'ไม่ระบุ', '0', 5, 'วันทนา', 'บุญนก', '', '0896430835', 'ค้าขาย', '0'),
('10008', '1609901134491', 3, 'อาณากร', 'กิติฐากร', '3601000304476', '0', 'ไม่ระบุ', '0', 0, '', '', '', '0', 'ไม่ระบุ', '0', 3, 'อาณากร', 'กิติฐากร', '', '0831613630', 'รับจ้าง', '0'),
('10009', '1609901128881', 3, 'โรม', 'ทับทิมทอง', '3600100093611', '0', 'ไม่ระบุ', '0', 5, 'เนาวรัตน์', 'อู่แสงทอง', '3720400706413', '0', 'ไม่ระบุ', '0', 3, 'โรม', 'ทับทิมทอง', '', '0869385952', 'ธุรกิจส่วนตัว', '0'),
('10010', '1609901137074', 3, 'ฉัตรชัย', 'นวลอินทร์', '5609900042552', '0', 'ไม่ระบุ', '0', 5, 'จิราภรณ์', 'รุ่งเรือง', '1101800620885', '0', 'ไม่ระบุ', '0', 5, 'จิราภรณ์', 'รุ่งเรือง', '', '0904583225', 'รับจ้าง', '0'),
('10011', '1601001138514', 3, 'ปรีชา', 'เทียนเงิน', '3609900285165', '0', 'ไม่ระบุ', '0', 4, 'ทวีพร', 'เทียนเงิน', '1709900202122', '0', 'ไม่ระบุ', '0', 4, 'ทวีพร', 'เทียนเงิน', '', '0898564179', 'รับจ้าง', '0'),
('10012', '1619900608375', 3, 'ไพโรจน์', 'จันทร์สี', '3601000308277', '0', 'ไม่ระบุ', '0', 5, 'วราภรณ์', 'ต่วนเทศ', '3601000255874', '0', 'ไม่ระบุ', '0', 5, 'วราภรณ์', 'ต่วนเทศ', '', '', 'ค้าขาย', '0'),
('10013', '1600102142231', 3, 'จิระเจตน์', 'สุรนันท์ธร', '3601000131237', '0', 'ไม่ระบุ', '0', 5, 'อารีวรรณ', 'แสงโพธิ์', '1619900127105', '0', 'ไม่ระบุ', '0', 5, 'อารีวรรณ', 'แสงโพธิ์', '', '0849121687', 'แม่บ้าน', '0'),
('10015', '1129701572138', 3, 'ธนวัจน์', 'โกนซา', '1600100308158', '0', 'ไม่ระบุ', '0', 5, 'กัลยา', 'ครูบรรณ์', '1601100196954', '0', 'ไม่ระบุ', '0', 5, 'กัลยา', 'ครูบรรณ์', '', '0899587960', 'รับจ้าง', '0'),
('10016', '1609901144178', 3, 'ไพศาล', 'ทองพรม', '3601000090654', '0', 'ไม่ระบุ', '0', 4, 'สุพัตรา', 'ทองพรม', '3601000358151', '0', 'ไม่ระบุ', '0', 4, 'สุพัตรา', 'ทองพรม', '', '0869335304', 'ค้าขาย', '0'),
('10017', '1609901144186', 3, 'ไพศาล', 'ทองพรม', '3601000090654', '0', 'ไม่ระบุ', '0', 4, 'สุพัตรา', 'ทองพรม', '3601000358151', '0', 'ไม่ระบุ', '0', 4, 'สุพัตรา', 'ทองพรม', '', '0869335304', 'ค้าขาย', '0'),
('10020', '1600102135595', 3, 'โชคอนันต์', 'นิลสนธิ', '3601000646873', '0', 'ไม่ระบุ', '0', 4, 'ฐิตินันท์', 'นิลสนธิ', '3550300077271', '0', 'ไม่ระบุ', '0', 3, 'โชคอนันต์', 'นิลสนธิ', '', '087-200080', 'รับราชการ', '0'),
('10022', '1609700312871', 3, 'พิษณุ', 'แก้วสี', '1609700152254', '0', 'ไม่ระบุ', '0', 5, 'อาริสา', 'ทัพเจริญ', '1609700166174', '0', 'ไม่ระบุ', '0', 5, 'อาริสา', 'ทัพเจริญ', '', '0931707956', 'เกษตรกรรม', '0'),
('10024', '1189900619410', 3, 'อดิศักดิ์', 'ไม้ตะเภา', '3180200311488', '0', 'ไม่ระบุ', '0', 5, 'เกษร', 'ทองมี', '1670500135439', '0', 'ไม่ระบุ', '0', 3, 'อดิศักดิ์', 'ไม้ตะเภา', '', '0843822561', 'ค้าขาย', '0'),
('10025', '1609901167151', 3, 'นรินทร์ธนัส', 'สังข์ทอง', '1600100288360', '0', 'ไม่ระบุ', '0', 5, 'สุภาวดี', 'เทพศิริ', '1600100343841', '0', 'ไม่ระบุ', '0', 5, 'สุภาวดี', 'เทพศิริ', '', '0946362650', 'ค้าขาย', '0'),
('10028', '1619900639424', 3, 'นครินทร์', 'วัฒนาณรงค์', '1619900159830', '0', 'ไม่ระบุ', '0', 4, 'ดวงกมล', 'ศรีทับทิม', '1600100460847', '0', 'ไม่ระบุ', '0', 4, 'ดวงกมล', 'ศรีทับทิม', '', '0808397716', 'แม่บ้าน', '0'),
('10029', '1103000300128', 3, 'นคร', 'พิริยะโภคานนท์', '3601000066150', '0', 'ไม่ระบุ', '0', 5, 'วนิชา', 'จุติคีรีสวรรค์', '3601000095192', '0', 'ไม่ระบุ', '0', 5, 'วนิชา', 'จุติคีรีสวรรค์', '', '0873150401', 'แม่บ้าน', '0'),
('10030', '1609700317318', 3, 'อภิชัย', 'อินอิ่ม', '1180200005631', '0', 'ไม่ระบุ', '0', 4, 'สมคิด', 'ใจฉ่ำ', '3600700899935', '0', 'ไม่ระบุ', '0', 4, 'สมคิด', 'ใจฉ่ำ', '', '0895680870', 'เกษตรกร', '0'),
('10031', '1609901172295', 3, 'สุรัตน์', 'สิริฟัก', '1609900288672', '0', 'ไม่ระบุ', '0', 5, 'มัทธุรส', 'เทพนาง', '1600100626095', '0', 'ไม่ระบุ', '0', 5, 'มัทธุรส', 'เทพนาง', '', '094-606260', 'รับจ้าง', '0'),
('10032', '1609901198898', 3, 'มานิตย์', 'เปียชวด', '3620101298772', '0', 'ไม่ระบุ', '0', 5, 'เสาวลักษณ์', 'หว่างเปีย', '1101401825548', '0', 'ไม่ระบุ', '0', 5, 'เสาวลักษณ์', 'หว่างเปีย', '', '0828816587', 'ธุรกิจส่วนตัว', '0'),
('10033', '1609901178102', 3, 'พรชัย', 'ตันรุ่งสุวรรณ', '3700400234066', '0', 'ไม่ระบุ', '0', 5, 'ปาริชาต', 'ศรีเพ็ง', '3601000079456', '0', 'ไม่ระบุ', '0', 5, 'ปาริชาต', 'ศรีเพ็ง', '', '0861190606', 'รับราชการ', '0'),
('10034', '1609901180646', 3, 'สุภเวช', 'วงษ์แก้ว', '3720900854730', '0', 'ไม่ระบุ', '0', 5, 'พรวฤณ', 'โตม่วง', '1600100256140', '0', 'ไม่ระบุ', '0', 5, 'พรวฤณ', 'โตม่วง', '', '089-708513', 'ค้าขาย', '0'),
('10035', '1609901196003', 3, 'ณัฐวุฒิ', 'กะวะระพฤษ', '3601000390437', '0', 'ไม่ระบุ', '0', 5, 'ปิยาภรณ์', 'สุพรรณศร', '5600500005163', '0', 'ไม่ระบุ', '0', 5, 'ปิยาภรณ์', 'สุพรรณศร', '', '089-860363', 'ลูกจ้าง', '0'),
('10036', '1600102144675', 3, 'รณชัย', 'ลอยบัณดิษฐ', '3610700028080', '0', 'ไม่ระบุ', '0', 5, 'นรีรัตน์', 'ธนะฤกษ์', '1609900108267', '0', 'ไม่ระบุ', '0', 5, 'นรีรัตน์', 'ธนะฤกษ์', '', '086-943644', 'แม่บ้าน', '0'),
('10037', '1609901212157', 3, 'สุรศักดิ์', 'สุขเสวี', '1180200066207', '0', 'ไม่ระบุ', '0', 5, 'ชุติมา', 'บุญอ่อน', '1180200057135', '0', 'ไม่ระบุ', '0', 5, 'ชุติมา', 'บุญอ่อน', '', '087-200053', 'ธุรกิจส่วนตัว', '0'),
('10038', '1648900195703', 3, 'ธาราดล', 'พวงสมบัติ', '1609900032031', '0', 'ไม่ระบุ', '0', 5, 'ขวัญดาว', 'กลิ่นเกษร', '1640600101684', '0', 'ไม่ระบุ', '0', 4, 'พรทิพย์', 'พวงสมบัติ', '', '087-208720', '', '0'),
('10039', '1619900654831', 3, 'อุทัย', 'ตรงเมธี', '3360200433182', '0', 'ไม่ระบุ', '0', 5, 'นริศรา', 'สิทธิวงศ์', '1711000062696', '0', 'ไม่ระบุ', '0', 5, 'นริศรา', 'สิทธิวงศ์', '', '097-973603', 'แม่บ้าน', '0'),
('10040', '1609901175278', 3, 'เจริญ', 'สิงห์เถื่อน', '3601000667919', '0', 'ไม่ระบุ', '0', 5, 'วิราพร', 'จันทร์บัวลา', '3471201295794', '0', 'ไม่ระบุ', '0', 5, 'วิราพร', 'จันทร์บัวลา', '', '081-042286', 'รับจ้าง', '0'),
('10041', '1600102149731', 3, 'วัลลภ', 'นุชนุ่ม', '3601000147851', '0', 'ไม่ระบุ', '0', 4, 'ลัดดาวรรณ', 'นุชนุ่ม', '3601000383481', '0', 'ไม่ระบุ', '0', 4, 'ลัดดาวรรณ', 'นุชนุ่ม', '', '0862018239', 'รับราชการ', '0'),
('10042', '1609901195139', 3, 'ดนัย', 'สายคุณากร', '3600200127291', '0', 'ไม่ระบุ', '0', 5, 'วรรณนิษา', 'ศรีฉ่ำ', '1601000086308', '0', 'ไม่ระบุ', '0', 5, 'วรรณนิษา', 'ศรีฉ่ำ', '', '092-554828', 'รับจ้าง', '0'),
('10043', '1609901185567', 3, 'สง่า', 'แซ่น้า', '3530400222311', '0', 'ไม่ระบุ', '0', 5, 'สุรีรัตน์', 'ศรีฉ่ำ', '3601000267716', '0', 'ไม่ระบุ', '0', 0, '', '', '', '0', '', '0'),
('10044', '1219901557221', 3, 'ธนะวิทย์', 'เรืองสกุล', '3101600705581', '0', 'ไม่ระบุ', '0', 5, 'กนกวรรณ', 'แสงสำเภา', '3601000494330', '0', 'ไม่ระบุ', '0', 5, 'กนกวรรณ', 'แสงสำเภา', '', '089-039487', 'รับจ้าง', '0'),
('10045', '1619900642018', 3, 'นราศักดิ์', 'สำรองพันธ์', '1480500002431', '0', 'ไม่ระบุ', '0', 5, 'นันทพัชร์', 'ป้อมเหม็ง', '1619900130475', '0', 'ไม่ระบุ', '0', 0, 'ไม่ระบุ', 'ไม่ระบุ', '', '0', '', '0'),
('10046', '1619900650932', 3, 'วรฤทธิเดช', 'แสงสนิท', '1539900067529', '0', 'ไม่ระบุ', '0', 5, 'ปภาวดี', 'ป้อมเหม็ง', '1619900280990', '0', 'ไม่ระบุ', '0', 0, 'ไม่ระบุ', 'ไม่ระบุ', '', '0', '', '0'),
('10047', '1609901212637', 3, 'อลงกรณ์', 'จันทร์ลา', '3670400216948', '0', 'ไม่ระบุ', '0', 4, 'กมลชนก', 'จันทร์ลา', '5601100023769', '0', 'ไม่ระบุ', '0', 4, 'กมลชนก', 'จันทร์ลา', '', '881493728', 'พยาบาล', '0'),
('10048', '1609901175928', 3, 'จุลพงศ์', 'สิงห์เถื่อน', '1529900458391', '0', 'ไม่ระบุ', '0', 5, 'นวลจันทร์', 'ปวนปันวงศ์', '1529900360536', '0', 'ไม่ระบุ', '0', 5, 'นวลจันทร์', 'ปวนปันวงศ์', '', '0613451806', 'รับจ้าง', '0'),
('10049', '1601001141337', 3, 'จักรกฤษณ์', 'ภู่เกต', '1601000084119', '0', 'ไม่ระบุ', '0', 5, 'สุดารัตน์', 'นิ่มมาศ', '1601000082698', '0', 'ไม่ระบุ', '0', 5, 'สุดารัตน์', 'นิ่มมาศ', '', '0650010716', 'รับจ้าง', '0'),
('10050', '1600102153429', 3, 'ธีรยุทธ', 'ศรีเพ็ง', '3601000654582', '0', 'ไม่ระบุ', '0', 5, 'เพชรัตน์', 'อิ่มเนย', '1600100196325', '0', 'ไม่ระบุ', '0', 5, 'เพชรัตน์', 'อิ่มเนย', '', '0946426151', 'ค้าขาย', '0'),
('10051', '1149901375131', 3, 'สัญชัย', 'คุ้มภัย', '1619900016052', '0', 'ไม่ระบุ', '0', 5, 'เหมือนฝัน', 'ฉิมสร', '1141100068373', '0', 'ไม่ระบุ', '0', 0, '', '', '', '0', '', '0'),
('10052', '1600102152848', 3, 'วิเลิศ', 'ปั้นด้วง', '3600200262253', '0', 'ไม่ระบุ', '0', 5, 'วิไลพร', 'ยมนา', '1600200002166', '0', 'ไม่ระบุ', '0', 5, 'วิไลพร', 'ยมนา', '', '0887809067', 'รับราชการ', '0'),
('10053', '1619900646625', 3, 'จำรัส', 'จันทร์สี', '3601000304531', '0', 'ไม่ระบุ', '0', 5, 'จิตติมา', 'จันทร์สี', '1300500047338', '0', 'ไม่ระบุ', '0', 5, 'จิตติมา', 'จันทร์สี', '', '0805156176', 'เกษตรกร', '0'),
('10054', '1600102144977', 3, 'สุชาติ', 'พุ่มเจริญ', '3601000428884', '0', 'ไม่ระบุ', '0', 5, 'ณภัทศรันย์', 'แว่นแก้ว', '3601000645290', '0', 'ไม่ระบุ', '0', 5, 'ณภัทศรันย์', 'แว่นแก้ว', '', '0833308824', 'แม่บ้าน', '0'),
('10055', '1600102151787', 3, '', '', '1', '0', 'ไม่ระบุ', '0', 4, '', '', '', '0', 'ไม่ระบุ', '0', 0, '', '', '', '0', '', '0'),
('10056', '1600102157211', 3, 'อำนวย', 'พวงสมบัติ', '3601000277827', '0', 'ไม่ระบุ', '0', 4, 'สุดารัตน์', 'พวงสมบัติ', '3601200006622', '0', 'ไม่ระบุ', '0', 3, 'อำนวย', 'พวงสมบัติ', '', '0836211088', 'เกษตรกร', '0'),
('10057', '1619900653648', 3, 'จีรศักดิ์', 'ทองอิ่ม', '1601000087401', '0', 'ไม่ระบุ', '0', 5, 'ธัญวรรณ', 'ขำพูล', '1619900193043', '0', 'ไม่ระบุ', '0', 5, 'ธัญวรรณ', 'ขำพูล', '', '0887674937', 'รับจ้าง', '0'),
('10058', '1600102155448', 3, 'ชัชชาย', 'พูลประดิษฐ', '3101100353970', '0', 'ไม่ระบุ', '0', 5, 'มยุรี', 'ยศสมบัติ', '5601000019093', '0', 'ไม่ระบุ', '0', 5, 'มยุรี', 'ยศสมบัติ', '', '0824621508', 'ค้าขาย', '0'),
('10059', '1600102157882', 3, 'ธีรพร', 'ออระเอี่ยม', '2', '0', 'ไม่ระบุ', '0', 4, 'มณฑิชา', 'ออระเอี่ยม', '', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('10060', '1601001140888', 3, 'บัณฑิต', 'ไล้ทอง', '3601000131504', '0', 'ไม่ระบุ', '0', 5, 'จรรยา', 'แสนหมี่', '8630784046085', '0', 'ไม่ระบุ', '0', 5, 'จรรยา', 'แสนหมี่', '', '085-538651', 'แม่บ้าน', '0'),
('10061', '1609901172104', 3, 'ยุทธนา', 'แตงพรม', '1600100318439', '0', 'ไม่ระบุ', '0', 5, 'รพีพร', 'เพ็งผจญ', '1320900128017', '0', 'ไม่ระบุ', '0', 5, 'รพีพร', 'เพ็งผจญ', '', '0853633739', 'รับจ้าง', '0'),
('10062', '1619900649730', 3, 'สุรชัย', 'มีหวาน', '1601000005553', '0', 'ไม่ระบุ', '0', 4, 'พัชรา', 'มีหวาน', '1619900142473', '0', 'ไม่ระบุ', '0', 4, 'พัชรา', 'มีหวาน', '', '086-210890', 'รับจ้าง', '0'),
('10063', '1609901191095', 3, 'นิติพงษ์', 'แสงสุข', '1100701135848', '0', 'ไม่ระบุ', '0', 5, 'ปรียานุช', 'เขียวแก้ว', '1601000075632', '0', 'ไม่ระบุ', '0', 5, 'ปรียานุช', 'เขียวแก้ว', '', '080-925219', 'ค้าขาย', '0'),
('10064', '1247400013846', 3, 'สมบัติ', 'พรหมริ้ว', '5320500042118', '0', 'ไม่ระบุ', '0', 5, 'อัญชลี', 'แว่นแก้ว', '1180200006638', '0', 'ไม่ระบุ', '0', 0, '', '', '', '0', '', '0'),
('10066', '1619900649632', 3, 'สุริยันต์', 'แสงเทียนประไพ', '1619900173727', '0', 'ไม่ระบุ', '0', 5, 'ฉัตรสุดา', 'มณีวงษ์', '1620300053706', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('10067', '1609901195911', 3, 'ธีรภัทร์', 'บุญเกตุ', '3601000228583', '0', 'ไม่ระบุ', '0', 5, 'พีรกานต์', 'ยาระเขตต์', '1600100018184', '0', 'ไม่ระบุ', '0', 5, 'พีรกานต์', 'ยาระเขตต์', '', '0856021108', 'พนักงานรัฐวิสาหกิจ', '0'),
('10068', '1189900629407', 3, 'พีรพันธุ์', 'สุวรรณ์', '3601101144407', '0', 'ไม่ระบุ', '0', 5, 'ณัฐวรรณ', 'บุญเกตุ', '3180200191750', '0', 'ไม่ระบุ', '0', 5, 'ณัฐวรรณ', 'บุญเกตุ', '', '080-853363', 'รับจ้าง', '0'),
('10069', '1609901162656', 3, 'อนุวัต', 'เส็งสุข', '3601000126187', '0', 'ไม่ระบุ', '0', 5, 'กาญจนา', 'สีสด', '1180200074447', '0', 'ไม่ระบุ', '0', 5, 'กาญจนา', 'สีสด', '', '098-526281', 'ค้าขาย', '0'),
('10070', '1619900635127', 3, 'วัชระ', 'ขำอิง', '1610300010098', '0', 'ไม่ระบุ', '0', 5, 'ชมพูนุช', 'ยิ้มแย้มแสง', '1100200304442', '0', 'ไม่ระบุ', '0', 5, 'ชมพูนุช', 'ยิ้มแย้มแสง', '', '080-684409', 'ค้าขาย', '0'),
('10071', '1609901152219', 3, 'ดุสิต', 'อ่วมทอน', '1180200040593', '0', 'ไม่ระบุ', '0', 5, 'นันทวัน', 'กวางทอง', '1180200074188', '0', 'ไม่ระบุ', '0', 5, 'นันทวัน', 'กวางทอง', '', '090-686829', 'เกษตรกร', '0'),
('10072', '1189900614621', 3, 'ธนวัฒน์', 'ด้วงไทย', '3180400388841', '0', 'ไม่ระบุ', '0', 5, 'ชื่นกมล', 'ทองเกล็ด', '3601000525707', '0', 'ไม่ระบุ', '0', 5, 'ชื่นกมล', 'ทองเกล็ด', '', '081-596872', 'เกษตรกร', '0'),
('10073', '1600102134611', 3, 'สมศักดิ์', 'ฟือสันเทียะ', '3300800496517', '0', 'ไม่ระบุ', '0', 5, 'ปัทมวรรณ', 'ฟือสันเทียะ', '1600100738888', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('10074', '1609901127991', 3, 'สาธิต', 'อินทร์ศักดิ์', '1600100504755', '0', 'ไม่ระบุ', '0', 5, 'ปวีณา', 'มั่นศักดิ์', '1619900220989', '0', 'ไม่ระบุ', '0', 5, 'ปวีณา', 'มั่นศักดิ์', '', '093-190194', 'เกษตรกร', '0'),
('10075', '1609901138879', 3, 'ณรงฤทธิ์', 'วรอินทร์', '3600400013257', '0', 'ไม่ระบุ', '0', 5, 'ชลิดา', 'ทองสุข', '3601000522431', '0', 'ไม่ระบุ', '0', 5, 'ชลิดา', 'ทองสุข', '', '081-727355', 'รับจ้าง', '0'),
('10076', '1600102139035', 3, 'ธวัชชัย', 'ต่วนเทศ', '3601000283258', '0', 'ไม่ระบุ', '0', 4, 'นันทวัน', 'ต่วนเทศ', '3601000289787', '0', 'ไม่ระบุ', '0', 4, 'นันทวัน', 'ต่วนเทศ', '', '089-272114', 'เกษตรกร', '0'),
('10077', '1139400078509', 3, 'ชัชชาย', 'พูลประดิษฐ', '3101100353970', '0', 'ไม่ระบุ', '0', 5, 'มยุรี', 'ยศสมบัติ', '5601000019093', '0', 'ไม่ระบุ', '0', 5, 'มยุรี', 'ยศสมบัติ', '', '082-462150', 'ค้าขาย', '0'),
('10078', '1600102104517', 3, 'สายชล', 'สีสุ่ม', '1619900102820', '0', 'ไม่ระบุ', '0', 5, 'สุพัตรา', 'เลิศชัย', '1180200051277', '0', 'ไม่ระบุ', '0', 5, 'สุพัตรา', 'เลิศชัย', '', '094-971848', 'เกษตรกร', '0'),
('10079', '1609901034542', 3, 'สมศักดิ์', 'แป๊ะเส็ง', '1609900030276', '0', 'ไม่ระบุ', '0', 4, 'มาลี', 'อยู่กรุง', '1619900097494', '0', 'ไม่ระบุ', '0', 4, 'มาลี', 'อยู่กรุง', '', '089-268528', 'รับจ้าง', '0'),
('10085', '1619900606631', 3, 'สิริวัฒน์', 'โสภาพงษ์', '1600400103331', '0', 'ไม่ระบุ', '0', 5, 'เกตุสุดา', 'แหยมรัตน์', '1600100089308', '0', 'ไม่ระบุ', '0', 5, 'เกตุสุดา', 'แหยมรัตน์', '', '085-733363', 'ค้าขาย', '0'),
('10086', '1129902406251', 3, 'AHMAD', 'CHAKER', '1979084', '0', 'ไม่ระบุ', '0', 5, 'พรปวีณ์', 'ว่องธัญญการ', '3601000108651', '0', 'ไม่ระบุ', '0', 5, 'พรปวีณ์', 'ว่องธัญญการ', '', '089-567634', 'แม่บ้าน', '0'),
('10087', '1189900612377', 3, 'อุบล', 'มั่นพุฒ', '3180200246180', '0', 'ไม่ระบุ', '0', 4, 'ปรานอม', 'มั่นพุฒ', '3180200192161', '0', 'ไม่ระบุ', '0', 4, 'ปรานอม', 'มั่นพุฒ', '', '082-885997', 'เกษตรกร', '0'),
('10088', '1600102158561', 3, 'สมพงษ์', 'พยัคฆเพศ', '1600200063971', '0', 'ไม่ระบุ', '0', 4, 'เจนจิรา', 'พยัคฆเพศ', '1102001220551', '0', 'ไม่ระบุ', '0', 4, 'เจนจิรา', 'พยัคฆเพศ', '', '092-723472', 'พนักงานบริษัท', '0'),
('10089', '1609901159221', 3, 'ศราวุธ', 'โตม่วง', '1600100241312', '0', 'ไม่ระบุ', '0', 5, 'ผกามาศ', 'โตม่วง', '1609900115646', '0', 'ไม่ระบุ', '0', 5, 'ผกามาศ', 'โตม่วง', '', '084-380063', 'รับจ้าง', '0'),
('10090', '1189900651003', 3, 'ไชยโย', 'พันธุ์เขตร์กิจ', '3620500266238', '0', 'ไม่ระบุ', '0', 4, 'รัตนา', 'พันธุ์เขตร์กิจ', '3180200230526', '0', 'ไม่ระบุ', '0', 4, 'รัตนา', 'พันธุ์เขตร์กิจ', '', '0', 'แม่บ้าน', '0'),
('10092', '1209000638361', 3, 'สุธน', 'คล้ายปาน', '1600100232321', '0', 'ไม่ระบุ', '0', 5, 'แสงดาว', 'กินวงษ์', '1419900002916', '0', 'ไม่ระบุ', '0', 3, 'สุธน', 'คล้ายปาน', '', '081-740238', '', '0'),
('10094', '1601001140217', 3, '', '', '3', '0', 'ไม่ระบุ', '0', 5, 'ณิชกมล', 'เลี้ยงกลับ', '1601000084381', '0', 'ไม่ระบุ', '0', 5, 'ศิริวรรณ', 'คุ้มปรีดี', '', '062-371947', 'ค้าขาย', '0'),
('10095', '1309801741576', 3, 'พนม', 'เข็มอินทร์', '3301900162191', '0', 'ไม่ระบุ', '0', 5, 'นันท์ณภัทสร', 'พิมแก้ว', '1120600006244', '0', 'ไม่ระบุ', '0', 5, 'นันท์ณภัทสร', 'พิมแก้ว', '', '098-748004', 'ลูกจ้าง', '0'),
('10096', '1619900609240', 3, 'กิตติพงษ์', 'มีมุข', '3601000666858', '0', 'ไม่ระบุ', '0', 5, 'นิภาพรรณ', 'อินมั่น', '1600100243935', '0', 'ไม่ระบุ', '0', 5, 'นิภาพรรณ', 'อินมั่น', '', '', 'รับจ้าง', '0'),
('10097', '1609901032558', 3, 'ธีรยุทธ', 'อินมณี', '1180200056848', '0', 'ไม่ระบุ', '0', 5, 'นิภาวรรณ', 'จันทร์แจ่ม', '1601100129955', '0', 'ไม่ระบุ', '0', 4, 'อรุณ', 'อินมณี', '', '086-206314', 'เกษตรกร', '0'),
('10098', '1609901041158', 3, 'จำเริญ', 'อากาศสุภา', '3190900062316', '0', 'ไม่ระบุ', '0', 4, 'ศรุตา', 'อากาศสุภา', '3601000284980', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('10099', '1609901186474', 3, 'ชาญณรงค์', 'ยอดนิล', '1600100430077', '0', 'ไม่ระบุ', '0', 5, 'วริศรา', 'ยศสมบัติ', '1180200063178', '0', 'ไม่ระบุ', '0', 0, '', '', '', '0', '', '0'),
('10100', '1419902950421', 3, 'ธิติพงศ์', 'อุทกโยธะ', '1430500004859', '0', 'ไม่ระบุ', '0', 5, 'สุธิดา', 'จันสำเภา', '1600100425472', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('10101', '1609901182355', 3, 'อำนวย', 'สังข์แตง', '3600300353315', '0', 'ไม่ระบุ', '0', 5, 'ศิริวิมล', 'เอี่ยมนุช', '1659900488922', '0', 'ไม่ระบุ', '0', 0, '', '', '', '0', '', '0'),
('10102', '1600102110860', 3, 'กิจจาพจน์', 'ทาเครือ', '3609900305191', '0', 'ไม่ระบุ', '0', 5, 'จิตตราพร', 'ก้อนทอง', '1619900086913', '0', 'ไม่ระบุ', '0', 5, 'จิตตราพร', 'ก้อนทอง', '', '0968314761', 'รับจ้าง', '0'),
('10104', '1601001136619', 3, 'มนัส', 'ประสพสุข', '1709800032349', '0', 'ไม่ระบุ', '0', 5, 'นุชจิรา', 'แก้วกุล', '1130300079084', '0', 'ไม่ระบุ', '0', 5, 'นุชจิรา', 'แก้วกุล', '', '093-471583', 'เกษตรกร', '0'),
('10105', '1600102113702', 3, 'ธีรพงษ์', 'ทองเกล็ด', '3601000525715', '0', 'ไม่ระบุ', '0', 5, 'มณฑกาญจน์', 'เทียมไพรวัลย์', '1619900024233', '0', 'ไม่ระบุ', '0', 5, 'มณฑกาญจน์', 'เทียมไพรวัลย์', '', '088-164076', 'เกษตรกร', '0'),
('10106', '1600102133274', 3, 'เกรียงไกร', 'ศรีวิระ', '1160400089197', '0', 'ไม่ระบุ', '0', 5, 'ณัฐยา', 'ใจฉ่ำ', '1619900097656', '0', 'ไม่ระบุ', '0', 3, 'นงค์', 'ใจฉ่ำ', '', '089-520409', 'เกษตรกร', '0'),
('10107', '1609901060217', 3, '', '', '3601000547883', '0', 'ไม่ระบุ', '0', 4, '', '', '1600100043219', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('10108', '1600102134823', 3, 'สุเทพ', 'ขาวสะอาด', '3610100219721', '0', 'ไม่ระบุ', '0', 5, 'กาญจนา', 'จิ๋วสุข', '3601000664561', '0', 'ไม่ระบุ', '0', 5, 'กาญจนา', 'จิ๋วสุข', '', '089-957064', 'แม่บ้าน', '0'),
('10109', '1609901206670', 3, 'ณัฐพล', 'กิติยา', '1619900196468', '0', 'ไม่ระบุ', '0', 5, 'เกศนภา', 'มีอ่อน', '1619900202379', '0', 'ไม่ระบุ', '0', 5, 'เกศนภา', 'มีอ่อน', '', '086-205035', 'รับจ้าง', '0'),
('10112', '1209000850432', 3, 'สมาน', 'กองแก้ว', '1330400014659', '0', 'ไม่ระบุ', '0', 5, 'วราภรณ์', 'อยู่เย็น', '1601000073028', '0', 'ไม่ระบุ', '0', 4, 'อนงค์', 'อยู่เย็น', '', '0', 'รับจ้าง', '0'),
('10113', '1609901180298', 3, 'ปฏิพัทธ์', 'ช้วนตระกูล', '1102700705944', '0', 'ไม่ระบุ', '0', 5, 'อัมพวัน', 'เกิดอยู่', '1601000088670', '0', 'ไม่ระบุ', '0', 4, 'แรมจันทร์', 'เกิดอยู่', '', '089-590453', 'เกษตรกร', '0'),
('10114', '1600102141994', 3, 'ปิยะพงษ์', 'เอี่ยมอรุณ', '1619900020351', '0', 'ไม่ระบุ', '0', 5, 'วีระยา', 'บำรุงศรี', '1101401539294', '0', 'ไม่ระบุ', '0', 3, 'ปิยะพงษ์', 'เอี่ยมอรุณ', '', '097-959001', 'ธุรกิจส่วนตัว', '0'),
('10115', '1619900607115', 3, 'เทวา', 'อุ่นใจ', '1619900167662', '0', 'ไม่ระบุ', '0', 5, 'มิลธิชา', 'เผือกกล่อม', '1209700399288', '0', 'ไม่ระบุ', '0', 4, 'ลำพึง', 'ลอยบัณดิษฐ', '', '086-943644', 'รับจ้าง', '0'),
('10116', '1609901198855', 3, 'สราวุธ', 'วงพินิต', '1601000003551', '0', 'ไม่ระบุ', '0', 5, 'สุธิดา', 'เทียนสา', '1600100383044', '0', 'ไม่ระบุ', '0', 5, 'สุธิดา', 'เทียนสา', '', '082-895989', 'เกษตรกร', '0'),
('10117', '1601001139782', 3, 'ไพบูลย์', 'ท่อนแก้ว', '3670400439068', '0', 'ไม่ระบุ', '0', 5, 'อรวรรณ', 'สิงห์เถื่อน', '1619900140292', '0', 'ไม่ระบุ', '0', 4, 'กาญจนา', 'ชื่นโต', '', '0979279383', 'ค้าขาย', '0'),
('10118', '1209301301501', 3, 'บุญเลิศ', 'กลิ่นสุวรรณ', '3601000154857', '0', 'ไม่ระบุ', '0', 5, 'มาลิณี', 'คุณารัตนกุล', '1259700016842', '0', 'ไม่ระบุ', '0', 4, 'จำลอง', 'กลิ่นสุวรรณ', '', '087-013596', 'แม่บ้าน', '0'),
('10119', '1102004633813', 3, 'นพรัตน์', 'ว่านวัด', '3180200189275', '0', 'ไม่ระบุ', '0', 4, 'วัชราภรณ์', 'นุชนุ่ม', '3601000153621', '0', 'ไม่ระบุ', '0', 4, 'วัชราภรณ์', 'นุชนุ่ม', '', '084-762626', 'รับจ้าง', '0'),
('10120', '1189900627285', 3, 'สมชาย', 'ไทยโอสถ', '1180200047822', '0', 'ไม่ระบุ', '0', 5, 'อัญทิลา', 'สินปั่น', '1180200036723', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('10121', '1189900630952', 3, 'ธนพล', 'แจ่มมณี', '1180200058514', '0', 'ไม่ระบุ', '0', 5, 'มณีรัตน์', 'ชำนาญไพร', '1180200048608', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('10122', '1189900592350', 3, 'บัณฑิต', 'นิลสุ่ม', '3180100376189', '0', 'ไม่ระบุ', '0', 5, 'อรวรรณ', 'สิริพันธ์', '3601000175629', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('10123', '1209601791686', 3, 'เมธา', 'เพ็งคำ', '1480800031380', '0', 'ไม่ระบุ', '0', 5, 'นิราณี', 'รอดแจ่ม', '1840100377425', '0', 'ไม่ระบุ', '0', 4, 'ดวงเนตร', 'ว่องธัญญการ', '', '085-396086', 'รับจ้าง', '0'),
('10124', '1600102112480', 3, 'รุ่งนิรันดร์', 'อยู่โพธิ์', '1619900006383', '0', 'ไม่ระบุ', '0', 5, 'อรวรรณ', 'เจิมไทย', '3660500420741', '0', 'ไม่ระบุ', '0', 3, 'รุ่งนิรันดร์', 'อยู่โพธิ์', '', '094-357574', 'เกษตรกร', '0'),
('10126', '1600102146872', 3, 'ศราวุธ', 'เพ็ชรชนะ', '1600100418298', '0', 'ไม่ระบุ', '0', 5, 'พิมพิมล', 'ราชเมืองมูล', '1570400108139', '0', 'ไม่ระบุ', '0', 5, 'พิมพิมล', 'ราชเมืองมูล', '', '090-458972', 'ธุรกิจส่วนตัว', '0'),
('10128', '1619900585405', 3, 'วิเชษฐ', 'คำเหล็ก', '1619900005328', '0', 'ไม่ระบุ', '0', 5, 'ประกายรุ่ง', 'แก้วกา', '1301200044865', '0', 'ไม่ระบุ', '0', 4, 'สมควร', 'คำเหล็ก', '', '082-176428', 'รับจ้าง', '0'),
('10129', '1619900647753', 3, 'สรวรวงศ์', 'ธาวุฒิสกุล', '3840600366381', '0', 'ไม่ระบุ', '0', 5, 'กัลยา', 'ทองเผือก', '3601000174033', '0', 'ไม่ระบุ', '0', 5, 'กัลยา', 'ทองเผือก', '', '093-312125', 'แม่บ้าน', '0'),
('10130', '1189900645798', 3, 'วีระ', 'กันสุข', '5180200002074', '0', 'ไม่ระบุ', '0', 5, 'ภาณุมาศ', 'ราชัยธร', '1189900026818', '0', 'ไม่ระบุ', '0', 5, 'ภาณุมาศ', 'ราชัยธร', '', '0979231584', 'รับราชการ', '0'),
('10131', '1600102128815', 3, 'ณรงค์', 'อิ่มเนย', '3601000670227', '0', 'ไม่ระบุ', '0', 5, 'พยง', 'มีมุข', '3601000646059', '0', 'ไม่ระบุ', '0', 5, 'พยง', 'มีมุข', '', '084-895917', 'ค้าขาย', '0'),
('10132', '1609901143988', 3, 'วินัย', 'สาครสิทธิ์', '1619900126176', '0', 'ไม่ระบุ', '0', 5, 'ยุพาพร', 'ฤทธิ์เต็ม', '1619900195348', '0', 'ไม่ระบุ', '0', 5, 'ยุพาพร', 'ฤทธิ์เต็ม', '', '065-449574', 'ค้าขาย', '0'),
('10133', '1609901103927', 3, 'ประทีป', 'ไพรสุข', '3530900105542', '0', 'ไม่ระบุ', '0', 4, 'ลักขิณา', 'ไพรสุข', '3471000139820', '0', 'ไม่ระบุ', '0', 4, 'ลักขิณา', 'ไพรสุข', '', '089-075559', 'แม่บ้าน', '0'),
('9682', '1102004219600', 3, 'ราชรุจิ', 'กีรติบรรหาร', '1101800362932', '0', 'ไม่ระบุ', '0', 5, 'สุทธิชา', 'นกครุฑ', '1180200041107', '0', 'ไม่ระบุ', '0', 5, 'สุทธิชา', 'นกครุฑ', '', '083-875-30', 'พนักงานบริษัท', '0'),
('9684', '1103200226924', 3, 'สุรวิทย์ชัย', 'เพ็ชรวัตร', '42', '0', 'ไม่ระบุ', '0', 5, 'สมิตานันต์', 'สาเสน', '1219800060835', '0', 'ไม่ระบุ', '0', 4, 'เมฆรุ่ง', 'พุ่มเกษม', '', '086-085-48', 'รับจ้าง', '0'),
('9686', '1100202068525', 3, 'ปานทอง', 'ทัศมี', '5470600004926', '0', 'ไม่ระบุ', '0', 5, 'ทวีพร', 'พุทธรักษา', '3600700595821', '0', 'ไม่ระบุ', '0', 5, 'ทวีพร', 'พุทธรักษา', '', '089-444-42', 'รับราชการ', '0'),
('9688', '1609900984521', 3, 'จำลอง', 'แก่นเขียว', '3601000376418', '0', 'ไม่ระบุ', '0', 5, 'สายไหม', 'ทรทึก', '3430501294474', '0', 'ไม่ระบุ', '0', 4, 'จำนอง', 'แก่นเขียว', '', '087-810-15', 'ค้าขาย', '0'),
('9690', '1600102091091', 3, 'พรชัย', 'รอดสัมฤทธิ์', '3600200100903', '0', 'ไม่ระบุ', '0', 4, 'พัชรี', 'เปรมวิชัย', '3601000025461', '0', 'ไม่ระบุ', '0', 4, 'พัชรี', 'เปรมวิชัย', '', '083-955-82', 'รัับจ้าง', '0'),
('9691', '1600102095399', 3, 'อนุ', 'ทองคำ', '5610400016678', '0', 'ไม่ระบุ', '0', 4, 'อัจฉรา', 'ต๋าอ่อน', '3601000540625', '0', 'ไม่ระบุ', '0', 4, 'อัจฉรา', 'ต๋าอ่อน', '', '087-850-03', 'ทำไร่', '0'),
('9695', '1600102087426', 3, 'วีรยุทธ', 'โพธิ์ประจักร์', '1180200056465', '0', 'ไม่ระบุ', '0', 5, 'รัตนาภรณ์', 'นิลสนธิ', '1619900176351', '0', 'ไม่ระบุ', '0', 5, 'รัตนาภรณ์', 'นิลสนธิ', '', '086-216-65', 'แม่บ้าน', '0'),
('9699', '1104301311201', 3, 'วีระศักดิ์', 'เกษมสานต์', '3471500144925', '0', 'ไม่ระบุ', '0', 5, 'อุบลวรรณ', 'ฤทธิ์เอี่ยม', '3600200324011', '0', 'ไม่ระบุ', '0', 5, 'อุบลวรรณ', 'ฤทธิ์เอี่ยม', '', '086-216-65', 'พนักงานบริษัท', '0'),
('9703', '1601001134624', 3, 'อนุพันธ์', 'สร้อยประดิษฐ์', '1601200054272', '0', 'ไม่ระบุ', '0', 5, 'ยุวดี', 'ศรีพิพิธโภคา', '1102700202977', '0', 'ไม่ระบุ', '0', 5, 'ยุวดี', 'ศรีพิพิธโภคา', '', '089-782-65', 'แม่บ้าน', '0'),
('9710', '1600102092250', 3, 'อภิสิทธิ์', 'ชาลีนิวัฒน์', '1609700130285', '0', 'ไม่ระบุ', '0', 5, 'พณิดา', 'พัสสร', '1600100335104', '0', 'ไม่ระบุ', '0', 5, 'พณิดา', 'พัสสร', '', '080-681-93', 'ทำไร่', '0'),
('9729', '1609900986159', 3, 'สำเริง', 'ยอดนิล', '3100900708372', '0', 'ไม่ระบุ', '0', 5, 'ภัคจิรา', 'แย้มปรางค์', '3601000393916', '0', 'ไม่ระบุ', '0', 5, 'ภัคจิรา', 'แย้มปรางค์', '', '086-214-46', 'รับจ้าง', '0'),
('9731', '1601001134853', 3, 'ประเทือง', 'คงบัวภา', '3670500615879', '0', 'ไม่ระบุ', '0', 5, 'สุกัญญา', 'ภู่สุวรรณ์', '3601000349879', '0', 'ไม่ระบุ', '0', 3, 'ประเทือง', 'คงบัวภา', '', '084-926-31', 'ธุรกิจส่วนตัว', '0'),
('9741', '1619900577925', 3, 'เมธี', 'ศรีนุช', '3601000073229', '0', 'ไม่ระบุ', '0', 4, 'นันทกาญจน์', 'ศรีนุช', '1520500054766', '0', 'ไม่ระบุ', '0', 4, 'นันทกาญจน์', 'ศรีนุช', '', '092-193-65', 'ค้าขาย', '0'),
('9746', '1601001134306', 3, 'สุรินทร์', 'ปันสาร', '3540200645943', '0', 'ไม่ระบุ', '0', 5, 'เกศวดี', 'รุ่งศิริรัตน์', '3601000501263', '0', 'ไม่ระบุ', '0', 5, 'มนต์ฤดี', 'รุ่งศิริรัตน์', '', '086-214-78', 'ครู', '0'),
('9751', '1149901176040', 3, 'ธีรยุทธ', 'ศรีเพ็ง', '3601000654582', '0', 'ไม่ระบุ', '0', 5, 'เพชรัตน์', 'อิ่มเนย', '1600100196325', '0', 'ไม่ระบุ', '0', 5, 'เพชรัตน์', 'อิ่มเนย', '', '094-642-61', 'แม่บ้าน', '0'),
('9784', '1609901018083', 3, 'จตุรงค์', 'ทองเกล็ด', '1600100458311', '0', 'ไม่ระบุ', '0', 5, 'แสงทิพย์', 'เนไห', '1310200102716', '0', 'ไม่ระบุ', '0', 4, 'บังอร', 'ครุฑจันทร์', '', '0862051845', 'เกษตรกร', '0'),
('9785', '1609901058654', 0, '', '', '6', '0', 'ไม่ระบุ', '0', 0, '', '', '3', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9786', '1609901071090', 0, '', '', '7', '0', 'ไม่ระบุ', '0', 0, '', '', '4', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9791', '1600200128291', 0, 'โฆษิต', 'มาลาศรี', '3730200406017', '0', 'ไม่ระบุ', '0', 5, 'เพียงใจ', 'จิ๋วสุข', '160020001278', '0', 'ไม่ระบุ', '0', 0, 'โฆษิต', 'มาลาศรี', '', '', 'รับราชการ', '0'),
('9792', '1200901621133', 0, '', '', '8', '0', 'ไม่ระบุ', '0', 0, '', '', '5', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9793', '1609901039081', 0, '', '', '9', '0', 'ไม่ระบุ', '0', 0, '', '', '6', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9795', '1609901033317', 0, '', '', '10', '0', 'ไม่ระบุ', '0', 0, '', '', '7', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9796', '1601001136503', 0, '', '', '11', '0', 'ไม่ระบุ', '0', 0, '', '', '8', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9797', '1849300166132', 0, '', '', '12', '0', 'ไม่ระบุ', '0', 0, '', '', '9', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9798', '1629900964601', 0, '', '', '13', '0', 'ไม่ระบุ', '0', 0, '', '', '10', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9799', '1609901053555', 0, '', '', '14', '0', 'ไม่ระบุ', '0', 0, '', '', '11', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9800', '1600102092535', 3, 'ศักดา', 'จั่นฤทธิ์', '3601000624110', '0', 'ไม่ระบุ', '0', 5, 'วิไลวรรณ', 'ยศสมบัติ', '1601000072200', '0', 'ไม่ระบุ', '0', 5, 'วิไลวรรณ', 'ยศสมบัติ', '', '0862088090', '', '0'),
('9802', '1619900583551', 0, '', '', '4', '0', 'ไม่ระบุ', '0', 0, '', '', '1', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9806', '1609901050734', 0, '', '', '5', '0', 'ไม่ระบุ', '0', 0, '', '', '2', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9811', '1609901038548', 0, '', '', '20', '0', 'ไม่ระบุ', '0', 0, '', '', '17', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9812', '1609901029409', 0, '', '', '21', '0', 'ไม่ระบุ', '0', 0, '', '', '18', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9813', '1199901368992', 0, '', '', '32', '0', 'ไม่ระบุ', '0', 0, '', '', '29', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9815', '1609901054284', 0, '', '', '22', '0', 'ไม่ระบุ', '0', 0, '', '', '19', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9816', '1619900585979', 0, '', '', '33', '0', 'ไม่ระบุ', '0', 0, '', '', '30', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9818', '1600102088295', 3, 'อนุพงษ์', 'จันทา', '3609700055051', '0', 'ไม่ระบุ', '0', 4, 'กาญจนา', 'จันทา', '1619900082411', '0', 'ไม่ระบุ', '0', 4, 'กาญจนา', 'จันทา', '', '0946215557', 'รับจ้าง', '0'),
('9819', '1601001135736', 0, '', '', '15', '0', 'ไม่ระบุ', '0', 0, '', '', '12', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9823', '1600102103952', 0, '', '', '24', '0', 'ไม่ระบุ', '0', 0, '', '', '21', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9824', '1188500000756', 0, '', '', '25', '0', 'ไม่ระบุ', '0', 0, '', '', '22', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9827', '1609901037258', 0, '', '', '26', '0', 'ไม่ระบุ', '0', 0, '', '', '23', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9828', '1619900587629', 3, '', '', '27', '0', 'ไม่ระบุ', '0', 4, '', '', '24', '0', 'ไม่ระบุ', '0', 4, '', '', '', '', '', '0'),
('9829', '1600102108431', 0, '', '', '16', '0', 'ไม่ระบุ', '0', 0, '', '', '13', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9830', '1179900559565', 0, '', '', '28', '0', 'ไม่ระบุ', '0', 0, '', '', '25', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9832', '1609901041867', 0, '', '', '17', '0', 'ไม่ระบุ', '0', 0, '', '', '14', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9835', '1600102099858', 0, '', '', '29', '0', 'ไม่ระบุ', '0', 0, '', '', '26', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9837', '1168300145955', 0, '', '', '30', '0', 'ไม่ระบุ', '0', 0, '', '', '27', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9838', '1619900597942', 0, '', '', '18', '0', 'ไม่ระบุ', '0', 0, '', '', '15', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9841', '1609901023851', 3, 'อิศรา', 'ดาวท่าน', '1600100384920', '0', 'ไม่ระบุ', '0', 5, 'กุลนันท์', 'ทับทิมศรี', '1600100384920', '0', 'ไม่ระบุ', '0', 3, 'อิศรา', 'ดาวท่าน', '', '0980040454', 'รับจ้าง', '0'),
('9842', '1601001135167', 0, '', '', '31', '0', 'ไม่ระบุ', '0', 0, '', '', '28', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9845', '1600102096816', 3, 'นิรันดร์', 'แว่นแก้ว', '1619900026791', '0', 'ไม่ระบุ', '0', 5, 'เยาวภา', 'จันทร์เกิด', '1600100309774', '0', 'ไม่ระบุ', '0', 5, 'ณภัทศรันย์', 'แว่นแก้ว', '', '0949618130', 'แม่บ้าน', '0'),
('9853', '1305300075782', 0, '', '', '34', '0', 'ไม่ระบุ', '0', 0, '', '', '31', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9855', '1101700520714', 0, '', '', '35', '0', 'ไม่ระบุ', '0', 0, '', '', '32', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9856', '1319800650917', 0, '', '', '36', '0', 'ไม่ระบุ', '0', 0, '', '', '33', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9858', '1600102107257', 0, '', '', '37', '0', 'ไม่ระบุ', '0', 0, '', '', '34', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9861', '1609901037584', 0, '', '', '38', '0', 'ไม่ระบุ', '0', 0, '', '', '35', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9862', '1609901041590', 0, '', '', '39', '0', 'ไม่ระบุ', '0', 0, '', '', '36', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9863', '1189900571824', 0, '', '', '40', '0', 'ไม่ระบุ', '0', 0, '', '', '37', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9870', '1601001136597', 0, '', '', '41', '0', 'ไม่ระบุ', '0', 0, '', '', '38', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9874', '1139400066055', 0, '', '', '19', '0', 'ไม่ระบุ', '0', 0, '', '', '16', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9878', '1600102099785', 0, '', '', '23', '0', 'ไม่ระบุ', '0', 0, '', '', '20', '0', 'ไม่ระบุ', '0', 0, '', '', '', '', '', '0'),
('9884', '1529902531826', 3, 'จรัญ', 'คชาชาญ', '1601100145756', '0', 'ไม่ระบุ', '0', 5, 'ดวงเดือน', 'นามวงค์', '3521000154262', '0', 'ไม่ระบุ', '0', 5, 'ดวงเดือน', 'นามวงค์', '', '0850541183', 'พนักงานบริษัท', '0'),
('9885', '1609901114431', 3, 'วินัย', 'ลอยเมฆ', '3600200306196', '0', 'ไม่ระบุ', '0', 5, 'ศศิวิมล', 'พงษ์ภะเดิม', '1180200043550', '0', 'ไม่ระบุ', '0', 5, 'ศศิวิมล', 'พงษ์ภะเดิม', '', '081-146319', 'ีรับจ้าง', '0'),
('9886', '1609901082334', 3, 'นวพล', 'มั่นศักดิ์', '1600100500903', '0', 'ไม่ระบุ', '0', 5, 'ศิริรัตน์', 'มั่นศักดิ์', '1619900183722', '0', 'ไม่ระบุ', '0', 5, 'ศิริรัตน์', 'มั่่นศักดิ์', '', '096-269522', 'ค้าขาย', '0'),
('9887', '1609901089657', 3, 'นิรชัย', 'สิงห์เถื่อน', '1609900165996', '0', 'ไม่ระบุ', '0', 5, 'ศศิชา', 'พงษ์ภะเดิม', '1180200062651', '0', 'ไม่ระบุ', '0', 5, 'ศศิชา', 'พงษ์ภะเดิม', '', '085-601511', 'ค้าขาย', '0'),
('9888', '1609901074471', 3, 'แท่น', 'แดนนาสาร', '3450700728172', '0', 'ไม่ระบุ', '0', 4, 'วชิราวรรณ', 'แดนนาสาร', '3620500454841', '0', 'ไม่ระบุ', '0', 4, 'วชิราวรรณ', 'แดนนาสาร', '', '089-269016', 'ธุรกิจส่วนตัว', '0'),
('9890', '1209702805895', 3, 'วีรเดช', 'อุตศาสตร์', '3470400238013', '0', 'ไม่ระบุ', '0', 5, 'จิราภรณ์', 'บริบูรณ์', '1601000077023', '0', 'ไม่ระบุ', '0', 5, 'จิราภรณ์', 'บริบูรณ์', '', '061-810460', 'รับจ้าง', '0'),
('9891', '1600102119271', 3, 'รณชัย', 'ลอยบัญดิษฐ', '3610700028080', '0', 'ไม่ระบุ', '0', 5, 'นรีรัตน์', 'ธนะฤกษ์', '1609900108267', '0', 'ไม่ระบุ', '0', 0, 'นรีรัตน์', 'ธนะฤกษ์', '', '086-943644', 'ทำนา', '0'),
('9892', '1600102124704', 3, 'จักรกฤษณ์', 'คำประกอบ', '1600900109664', '0', 'ไม่ระบุ', '0', 5, 'สุรีวรรณ', 'นิลสนธิ', '1600100556321', '0', 'ไม่ระบุ', '0', 5, 'สุรีวรรณ', 'นิลสนธิ', '', '0806888449', 'ค้าขาย', '0'),
('9893', '1619900619113', 3, 'อเนก', 'นาคแจ้ง', '3601000252085', '0', 'ไม่ระบุ', '0', 4, 'นริศรา', 'เนินพลับ', '3601000562513', '0', 'ไม่ระบุ', '0', 4, 'นริศรา', 'เนินพลับ', '', '0890733192', 'แม่บ้าน', '0'),
('9894', '1609901122913', 3, 'ประเสริฐ', 'สมพร', '3900100473781', '0', 'ไม่ระบุ', '0', 5, 'ปานปิติ', 'ปัญญสดิลก', '3601000047163', '0', 'ไม่ระบุ', '0', 5, 'ปานปิติ', 'ปัญญสดิลก', '', '0810431045', 'รับราชการ', '0'),
('9896', '1601001138875', 3, 'สิทธา', 'พันธ์สิงห์', '3309901215376', '0', 'ไม่ระบุ', '0', 5, 'ลินดา', 'พงษ์ลีดา', 'CI0084929', '0', 'ไม่ระบุ', '0', 3, 'สิทธา', 'พันธ์สิงห์', '', '0912071127', 'รับจ้าง', '0'),
('9897', '1600102106153', 0, 'ไพโรจน์', 'แว่นแก้ว', '3601000647781', '0', 'ไม่ระบุ', '0', 0, 'ฐิติพร', 'แว่นแก้ว', '1601000081161', '0', 'ไม่ระบุ', '0', 0, 'ฐิติพร', 'แว่นแก้ว', '', '089-859707', 'แม่บ้าน', '0'),
('9898', '1601001138964', 3, 'ศิริ', 'ปานอุทัย', '3601000013340', '0', 'ไม่ระบุ', '0', 5, 'นงนุช', 'หาญสาริกิจ', '3609900802852', '0', 'ไม่ระบุ', '0', 5, 'นงนุช', 'หาญสาริกิจ', '', '0878384928', 'แม่บ้าน', '0'),
('9899', '1600102120750', 3, 'บุญเลิศ', 'อิ่มอยู่', '3601000021482', '0', 'ไม่ระบุ', '0', 5, 'ธัญญภรณ์', 'แพร่ศิริวุฒิพงศ์', '3119900035724', '0', 'ไม่ระบุ', '0', 5, 'ธัญญภรณ์', 'แพร่ศิริวุฒิพงศ์', '', '0999043543', 'แม่บ้าน', '0'),
('9902', '1609901118801', 3, 'พิทักษ', 'พวงสมบัติ', '3610600492639', '0', 'ไม่ระบุ', '0', 5, 'นิภาพร', 'หมั่นการนา', '1659900183935', '0', 'ไม่ระบุ', '0', 5, 'นิภาพร', 'หมั่นการนา', '', '083-718320', 'รับจ้าง', '0'),
('9904', '1601001138115', 3, 'สถาพร', 'มีมุข', '1600100481585', '0', 'ไม่ระบุ', '0', 5, 'ฐานมาศ', 'มีมุข', '1601000081730', '0', 'ไม่ระบุ', '0', 5, 'ฐานมาศ', 'มีมุข', '', '0862163495', '', '0'),
('9905', '1529902533691', 3, 'อาทิตย์', 'จันทร์แพ', '1600100389573', '0', 'ไม่ระบุ', '0', 5, 'วิมลวรรณ', 'ก๋าคำ', '1521100042893', '0', 'ไม่ระบุ', '0', 5, 'วิมลวรรณ', 'ก๋าคำ', '', '0872043416', 'รับจ้าง', '0'),
('9906', '1600102123767', 3, 'อุเทน', 'คงมี', '3660700425607', '0', 'ไม่ระบุ', '0', 5, 'เจนจิรา', 'วิชนี', '3660700185142', '0', 'ไม่ระบุ', '0', 5, 'เจนจิรา', 'วิชนี', '', '086-199133', 'รับราชการ', '0'),
('9908', '1600102101721', 0, 'ปวัน', 'มั่นศักดิ์', '1600100203861', '0', 'ไม่ระบุ', '0', 0, 'อุษา', 'ม่วงสิงห์', '1620100147898', '0', 'ไม่ระบุ', '0', 0, 'อุษา', 'ม่วงสิงห์', '', '', 'เกษตรกร', '0'),
('9910', '1600102117066', 3, 'กฤษฎา', 'คำเรืองศรี', '3620101146131', '0', 'ไม่ระบุ', '0', 4, 'สุภา', 'คำเรืองศรี', '2630700035797', '0', 'ไม่ระบุ', '0', 3, 'กฤษฎา', 'คำเรืองศรี', '', '0979674013', 'รับราชการ', '0'),
('9911', '1609901112675', 3, 'ธเนศ', 'โตเกิด', '1180200063194', '0', 'ไม่ระบุ', '0', 4, 'ณัฐธิดา', 'โตเกิด', '1609900185296', '0', 'ไม่ระบุ', '0', 4, 'ณัฐธิดา', 'โตเกิด', '', '0613519026', 'เกษตรกร', '0'),
('9912', '1609700309927', 3, 'นฤพนธ์', 'โพธิ์ป้อม', '1619900242699', '0', 'ไม่ระบุ', '0', 5, 'พิไลภรณ์', 'สำเภาลอย', '1609700165801', '0', 'ไม่ระบุ', '0', 5, 'พิไลภรณ์', 'สำเภาลอย', '', '0899594016', 'เกษตรกร', '0'),
('9913', '1609901086321', 3, 'สมยศ', 'ศรีธิธง', '3510101210086', '0', 'ไม่ระบุ', '0', 5, 'กัลยรัตน์', 'ฉายเพชร', '1601000081039', '0', 'ไม่ระบุ', '0', 5, 'กัลยรัตน์', 'ฉายเพชร', '', '0871994043', 'แม่บ้าน', '0'),
('9914', '1729900925221', 3, 'ณรงค์ฤทธิ์', 'ประกอบผล', '1259700006529', '0', 'ไม่ระบุ', '0', 5, 'ลักขณา', 'โนรี', '1179900024009', '0', 'ไม่ระบุ', '0', 5, 'ลักขณา', 'โนรี', '', '087-204173', 'ค้าขาย', '0'),
('9917', '1102004366475', 3, 'ศุภชัย', 'โพธิ์ทอง', '3670500701872', '0', 'ไม่ระบุ', '0', 5, 'ภัทราวดี', 'ภู่สิงห์', '3660300218281', '0', 'ไม่ระบุ', '0', 5, 'ภัทราวดี', 'ภู่สิงห์', '', '0851143836', 'พนักงานราชการ', '0'),
('9918', '1609901085341', 3, 'ไชยภพ', 'ผูกพันธ์', '1180200013456', '0', 'ไม่ระบุ', '0', 4, 'ศิรินภา', 'พวงสมบัติ', '1600100092694', '0', 'ไม่ระบุ', '0', 4, 'ศิรินภา', 'พวงสมบัติ', '', '0878431373', 'ทำไร่', '0'),
('9919', '1600102118127', 3, 'สำเนา', 'สนประเสริฐ', '3600700681158', '0', 'ไม่ระบุ', '0', 4, 'ปริศนา', 'สนประเสริฐ', '1600500103910', '0', 'ไม่ระบุ', '0', 4, 'ปริศนา', 'สนประเสริฐ', '', '082-771726', 'รับจ้าง', '0'),
('9920', '1600102119883', 3, 'พีรภัทร์', 'มั่นทอง', '3601000105481', '0', 'ไม่ระบุ', '0', 4, 'นงลักษณ์', 'มั่นทอง', '3601000643025', '0', 'ไม่ระบุ', '0', 4, 'นงลักษณ์', 'มั่นทอง', '', '087-521379', 'ลูกจ้างของหน่วยงานราชการ', '0'),
('9921', '1300101311821', 3, 'นริศ', 'ศิริสวัสดิ์', '1660600009753', '0', 'ไม่ระบุ', '0', 5, 'ปรียานุช', 'ปร้องทอง', '1601000075721', '0', 'ไม่ระบุ', '0', 5, 'ปรียานุช', 'ปร้องทอง', '', '089-272349', 'ูธุรกิจส่วนตัว', '0'),
('9922', '1609901114902', 3, 'วัลลภ', 'เย็นสุข', '3601000274593', '0', 'ไม่ระบุ', '0', 5, 'กฤษณา', 'มีผักใหม', '5400500053003', '0', 'ไม่ระบุ', '0', 3, 'วัลลภ', 'เย็นสุข', '', '083-218833', 'รับจ้าง', '0'),
('9923', '1609901104508', 3, 'กฤตภาส', 'คงชิต', '3102200781427', '0', 'ไม่ระบุ', '0', 5, 'สุจิตตาภรณ์', 'คงชิต', '3412000067205', '0', 'ไม่ระบุ', '0', 5, 'สุจิตตาภรณ์', 'คงชิต', '', '087-197975', 'แม่บ้าน', '0'),
('9924', '1609901100855', 3, 'ธเนส', 'ศรีศุภรพันธ์', '3601000053350', '0', 'ไม่ระบุ', '0', 5, 'ศศิฉาย', 'กลิ่นเกษร', '2619900020830', '0', 'ไม่ระบุ', '0', 5, 'ศศิฉาย', 'กลิ่นเกษร', '', '056-341182', 'รับจ้าง', '0'),
('9925', '1209702754948', 3, 'วสันต์', 'บุตรดี', '3601000086959', '0', 'ไม่ระบุ', '0', 5, 'วราภรณ์', 'อ่อนละมูล', '3601000263397', '0', 'ไม่ระบุ', '0', 5, 'วราภรณ์', 'อ่อนละมูล', '', '089-035258', 'ทำนา', '0'),
('9929', '1600102121098', 3, 'ฉลอง', 'พุกทอง', '3180600648307', '0', 'ไม่ระบุ', '0', 5, 'นงลักษ์', 'วินิตสร', '3601000651303', '0', 'ไม่ระบุ', '0', 5, 'นงลักษ์', 'วินิตสร', '', '097-928245', 'ีรับจ้าง', '0'),
('9933', '1609901111725', 3, 'เอกสิทธ์', 'บุญมา', '3190600329678', '0', 'ไม่ระบุ', '0', 5, 'มณียา', 'อัครวงษ์', '1180200012573', '0', 'ไม่ระบุ', '0', 5, 'มณียา', 'อัครวงษ์', '', '084-937559', 'ค้าขาย', '0'),
('9935', '1609901074714', 3, 'นพคุณ', 'น้อยสวัสดิ์', '1600100181140', '0', 'ไม่ระบุ', '0', 4, 'สมพร', 'สิงห์เถื่อน', '1609900067803', '0', 'ไม่ระบุ', '0', 4, 'สมพร', 'สิงห์เถื่อน', '', '085-593643', 'แม่บ้าน', '0'),
('9936', '1609901093425', 3, 'ศุภกิจ', 'สินเภตรา', '3600100860647', '0', 'ไม่ระบุ', '0', 4, 'สุพัตรา', 'สินเภตรา', '1620300013186', '0', 'ไม่ระบุ', '0', 4, 'สุพัตรา', 'สินเภตรา', '', '084-820323', 'แม่บ้าน', '0'),
('9937', '1600102125387', 3, 'ภัทรพล', 'คนตรง', '3601000098493', '0', 'ไม่ระบุ', '0', 5, 'รจนา', 'มีขำ', '3610700424864', '0', 'ไม่ระบุ', '0', 5, 'รจนา', 'มีขำ', '', '0847778064', 'ค้าขาย', '0'),
('9940', '1749700198997', 3, 'ประสพโชค', 'ผันสนาม', '5451100036234', '0', 'ไม่ระบุ', '0', 5, 'ฐิตินันท์', 'แก้วแสง', '3670200890971', '0', 'ไม่ระบุ', '0', 5, 'ฐิตินันท์', 'แก้วแสง', '', '0884584738', 'ค้าขาย', '0'),
('9941', '1189900596673', 3, 'ไมตรี', 'โตอิ้ม', '1180200011267', '0', 'ไม่ระบุ', '0', 5, 'มยุรี', 'กองแก้ง', '1189900087493', '0', 'ไม่ระบุ', '0', 3, 'ไมตรี', 'โตอิ้ม', '', '0828770325', 'ทำนา', '0'),
('9942', '1600102105416', 0, 'วิรัช', 'บำรุงศรี', '3601000122491', '0', 'ไม่ระบุ', '0', 0, 'จุฑากาญจน์', 'บำรุงศรี', '3601000129941', '0', 'ไม่ระบุ', '0', 0, 'วิรัช', 'บำรุงศรี', '', '0906899342', 'ทำนา', '0'),
('9943', '1609901111334', 3, 'สุวิชชา', 'ขุนศรี', '3100800522498', '0', 'ไม่ระบุ', '0', 5, 'นิสรายุ', 'ขำเมฆ', '3560600100961', '0', 'ไม่ระบุ', '0', 5, 'นิสรายุ', 'ขำเมฆ', '', '0813439068', 'ค้าขาย', '0'),
('9946', '1600102126065', 3, 'พัฒนา', 'อินแสงแวง', '3480100752935', '0', 'ไม่ระบุ', '0', 4, 'มณีรัตน์', 'ปาลวัฒน์', '3601000621951', '0', 'ไม่ระบุ', '0', 4, 'มณีรัตน์', 'ปาลวัฒน์', '', '089-208108', 'ค้าขาย', '0'),
('9951', '1609901115623', 3, 'สมัค', 'จันทร์สร้อย', '3101202987579', '0', 'ไม่ระบุ', '0', 4, 'สิริกาญจน์', 'จันทร์สร้อย', '3729900159398', '0', 'ไม่ระบุ', '0', 4, 'สิริกาญจน์', 'จันทร์สร้อย', '', '089-789472', 'รับจ้าง', '0'),
('9952', '1609901081338', 3, 'ปรีชา', 'อภิชาติ', '3600200064834', '0', 'ไม่ระบุ', '0', 5, 'ณีรนุช', 'สินธุพรหม', '3601000695165', '0', 'ไม่ระบุ', '0', 5, 'ณีรนุช', 'สินธุพรหม', '', '0932354693', 'แม่บ้าน', '0'),
('9953', '1609901109577', 3, 'ณรงค์ฤทธิ์', 'เอี่ยมสอาด', '1600400008664', '0', 'ไม่ระบุ', '0', 5, 'นงลักษณ์', 'สุวรรณพงษ์', '1601000072463', '0', 'ไม่ระบุ', '0', 5, 'นงลักษณ์', 'สุวรรณพงษ์', '', '083-316598', 'แม่บ้าน', '0'),
('9954', '1600102107371', 0, 'สมภพ', 'พรมจีน', '1600100376218', '0', 'ไม่ระบุ', '0', 0, 'จุฑารัตน์', 'สาททอง', '1600100376901', '0', 'ไม่ระบุ', '0', 0, 'จุฑารัตน์', 'สาททอง', '', '0848192377', 'รับจ้าง', '0'),
('9956', '1600102128149', 3, 'ณฤทธิ์', 'รอดเฉลิม', '1600100320689', '0', 'ไม่ระบุ', '0', 4, 'วริศรา', 'รอดเฉลิม', '1600100509498', '0', 'ไม่ระบุ', '0', 4, 'วริศรา', 'รอดเฉลิม', '', '0810421494', 'ค้าขาย', '0'),
('9958', '1189900586741', 3, 'เชาว์', 'คำวิเศษ', '1180200034364', '0', 'ไม่ระบุ', '0', 5, 'น้ำฝน', 'อ่อนสอาด', '3180200245281', '0', 'ไม่ระบุ', '0', 5, 'น้ำฝน', 'อ่อนสอาด', '', '086-206996', 'รับราชการ', '0'),
('9960', '1600102112145', 0, 'ธราวัฒน์', 'ฤทธิ์ทอง', '3601000505641', '0', 'ไม่ระบุ', '0', 0, 'เอ', '', '0060101006233', '0', 'ไม่ระบุ', '0', 0, 'ธราวัฒน์', 'ฤทธิ์ทอง', '', '', 'รับจ้าง', '0'),
('9962', '1609901081931', 3, 'อำนาจ', 'แตงพรม', '1609700135309', '0', 'ไม่ระบุ', '0', 5, 'วรรณนภา', 'กลิ่นรัตน์', '1103701137100', '0', 'ไม่ระบุ', '0', 5, 'วรรณนภา', 'กลิ่นรัตน์', '', '0862024453', 'แม่บ้าน', '0'),
('9963', '1609901125459', 3, 'สันติ', 'ทับทิมศรี', '3601000513504', '0', 'ไม่ระบุ', '0', 4, 'ศุวภัทร', 'ทับทิมศรี', '3601000502626', '0', 'ไม่ระบุ', '0', 4, 'ศุวภัทร', 'ทับทิมศรี', '', '0871961921', 'รับจ้าง', '0'),
('9964', '1129902377391', 3, 'วิฑูรย์', 'โสดแสง', '3601000506516', '0', 'ไม่ระบุ', '0', 4, 'ชุติมา', 'โสดแสง', '1670600115677', '0', 'ไม่ระบุ', '0', 3, 'วิฑูรย์', 'โสดแสง', '', '0822606602', 'รับราชการ', '0'),
('9965', '1601001139715', 3, 'เมธี', 'ศรีนุช', '3601000073229', '0', 'ไม่ระบุ', '0', 4, 'นันทกาญจน์', 'ศรีนุช', '1520500054766', '0', 'ไม่ระบุ', '0', 3, 'เมธี', 'ศรีนุช', '', '0987910237', '-', '0'),
('9966', '1609901141501', 3, 'นิรุต', 'ผิวอ่อน', '3601000650668', '0', 'ไม่ระบุ', '0', 5, 'วาสนา', 'พิพัฒน์เศรษฐกุล', '3620101421370', '0', 'ไม่ระบุ', '0', 5, 'วาสนา', 'พิพัฒน์เศรษฐกุล', '', '0810064407', 'รับจ้าง', '0'),
('9967', '1600102136711', 3, 'สุริฉาย', 'นิลสนธิ', '3601000138142', '0', 'ไม่ระบุ', '0', 4, 'แสงเพ็ญ', 'นิลสนธิ', '5609900019780', '0', 'ไม่ระบุ', '0', 3, 'สุริฉาย', 'นิลสนธิ', '', '0806826721', 'ค้าขาย', '0'),
('9968', '1103704797518', 3, 'สมพล', 'จันทร์ประสาท', '3710100369861', '0', 'ไม่ระบุ', '0', 4, 'กรรณิกา', 'จันทร์ประสาท', '5601090004023', '0', 'ไม่ระบุ', '0', 4, 'กรรณิกา', 'จันทร์ประสาท', '', '0810421494', 'รับจ้าง', '0'),
('9969', '1600102117481', 3, 'วันชนะ', 'ชุณหเมธาทิพย์', '1180200006166', '0', 'ไม่ระบุ', '0', 5, 'พัชรินทร์', 'ชุณหเมธาทิพย์', '1660300007453', '0', 'ไม่ระบุ', '0', 5, 'พัชรินทร์', 'ชุณหเมธาทิพย์', '', '0877952463', 'รับจ้าง', '0'),
('9970', '1609901119572', 3, 'สรณัฐ', 'เกิดศิริ', '1601000074857', '0', 'ไม่ระบุ', '0', 5, 'จุฑามาศ', 'เพชนะ', '1600100275501', '0', 'ไม่ระบุ', '0', 5, 'จุฑามาศ', 'เพชนะ', '', '0862093291', 'รับจ้าง', '0'),
('9971', '1247400011258', 3, 'สมบัติ', 'พรหมริ้ว', '5320500042118', '0', 'ไม่ระบุ', '0', 5, 'อัญชลี', 'แว่นแก้ว', '1180200006638', '0', 'ไม่ระบุ', '0', 5, 'อัญชลี', 'แว่นแก้ว', '', '0810457124', 'รับจ้าง', '0'),
('9972', '1619900633761', 3, 'ศักดา', 'บำรุงศรี', '1180200061477', '0', 'ไม่ระบุ', '0', 5, 'นิอร', 'มีอ่อน', '1619900153157', '0', 'ไม่ระบุ', '0', 5, 'นิอร', 'มีอ่อน', '', '0821609282', 'ลูกจ้างงานไฟฟ้า', '0'),
('9975', '1219901503520', 3, 'ปัญญา', 'นามวงษา', '1219900293998', '0', 'ไม่ระบุ', '0', 5, 'ปรางฐนิฏา', 'ปานศักดิ์', '1600100494431', '0', 'ไม่ระบุ', '0', 5, 'ปรางฐนิฏา', 'ปานศักดิ์', '', '0928761479', 'รับจ้าง', '0'),
('9976', '1500401227298', 3, 'ภานุพงษ์', 'แซ่หยาง', '8505073003706', '0', 'ไม่ระบุ', '0', 5, 'ภัทรวดี', 'ชัยรัตนรุ่งโรจน์', '1160100192324', '0', 'ไม่ระบุ', '0', 5, 'ภัทรวดี', 'ชัยรัตนรุ่งโรจน์', '', '0614463279', 'แม่บ้าน', '0'),
('9979', '1170601295746', 3, 'กมล', 'แก้วรักษา', '1170600103185', '0', 'ไม่ระบุ', '0', 5, 'สุชารัตน์', 'สุขประทีป', '1601200096412', '0', 'ไม่ระบุ', '0', 3, 'กมล', 'แก้วรักษา', '', '0877382820', 'พนักงานบริษัท', '0'),
('9980', '1409904262335', 3, 'ประเสริฐ', 'มีอาษา', '3331000861335', '0', 'ไม่ระบุ', '0', 5, 'ณภัสสร', 'ชุปวา', '1601000004085', '0', 'ไม่ระบุ', '0', 5, 'ณภัสสร', 'ชุปวา', '', '0800677707', 'รับจ้าง', '0'),
('9981', '1609901163831', 3, 'สมเกียรติ', 'ศรีฉ่ำ', '3601000662631', '0', 'ไม่ระบุ', '0', 5, 'ยุพา', 'ศรีฉ่ำ', '3601000079774', '0', 'ไม่ระบุ', '0', 5, 'ยุพา', 'ศรีฉ่ำ', '', '0992986584', 'รับจ้าง', '0'),
('9982', '1601001139243', 3, 'ชาตรี', 'สง่างาม', '3601000170283', '0', 'ไม่ระบุ', '0', 4, 'สุกัญญา', 'ฟักผล', '3601000512079', '0', 'ไม่ระบุ', '0', 4, 'สุกัญญา', 'ฟักผล', '', '0930364794', 'รับจ้าง', '0'),
('9983', '1600102131573', 3, 'วัฒนะ', 'กัลยาณ์พัฒนกุล', '3620101008391', '0', 'ไม่ระบุ', '0', 4, 'สุกัลยา', 'กัลยาณ์พัฒนกุล', '3620500260078', '0', 'ไม่ระบุ', '0', 4, 'สุกัลยา', 'กัลยาณ์พัฒนกุล', '', '0897053214', 'รับราชการ', '0'),
('9984', '1600102120610', 3, 'สุรกิจ', 'นิลสนธิ', '1180200070115', '0', 'ไม่ระบุ', '0', 5, 'ศิริลักษณ์', 'สงเนย', '1619900253241', '0', 'ไม่ระบุ', '0', 5, 'ศิริลักษณ์', 'สงเนย', '', '', 'แม่บ้าน', '0'),
('9986', '1609901168557', 3, 'สมพร', 'พุ่มศรี', '3601000171221', '0', 'ไม่ระบุ', '0', 4, 'นงค์รัก', 'พุ่มศรี', '3601000229059', '0', 'ไม่ระบุ', '0', 4, 'นงค์รัก', 'พุ่มศรี', '', '0862160991', 'ครูเอกชน', '0'),
('9987', '1609901160050', 3, 'ชัยวัฒน์', 'ดีฉนวน', '1600100284682', '0', 'ไม่ระบุ', '0', 5, 'สุกัญญา', 'ทองม่วง', '2619900017464', '0', 'ไม่ระบุ', '0', 5, 'สุกัญญา', 'ทองม่วง', '', '0992924060', 'แม่บ้าน', '0'),
('9989', '1609901117588', 3, 'ศุภชัย', 'เพ็ชรโต', '1609900221446', '0', 'ไม่ระบุ', '0', 5, 'สุนทรี', 'เย็นสุข', '1619900171830', '0', 'ไม่ระบุ', '0', 5, 'สุนทรี', 'เย็นสุข', '', '0931375727', 'ค้าขาย', '0'),
('9990', '1619900633787', 3, 'พยุงศักดิ์', 'ทองทุ่งโป่ง', '1619900026805', '0', 'ไม่ระบุ', '0', 5, 'อรทัย', 'สายสี', '1610300009910', '0', 'ไม่ระบุ', '0', 5, 'อรทัย', 'สายสี', '', '0845770929', 'รับราชการ', '0'),
('9991', '1601001139669', 3, 'รณชัย', 'ขอนทอง', '1620700045361', '0', 'ไม่ระบุ', '0', 5, 'กมลวรรณ', 'ผิวสอาด', '1600100269357', '0', 'ไม่ระบุ', '0', 5, 'กมลวรรณ', 'ผิวสอาด', '', '0810370028', 'รับจ้าง', '0'),
('9992', '1600102101623', 3, 'อนุวัฒน์', 'พวงสมบัติ', '1669700061194', '0', 'ไม่ระบุ', '0', 5, 'ลดาวัลย์', 'แสงอากาศ', '1600100080491', '0', 'ไม่ระบุ', '0', 5, 'ลดาวัลย์', 'แสงอากาศ', '', '0878440552', 'แม่บ้าน', '0'),
('9993', '1609901103676', 3, 'วิทยา', 'สิงห์เถื่อน', '3601000174769', '0', 'ไม่ระบุ', '0', 5, 'ประภัสสร', 'ภูมิใจ', '1600100347145', '0', 'ไม่ระบุ', '0', 5, 'ประภัสสร', 'ภูมิใจ', '', '0873103613', 'รับจ้าง', '0'),
('9994', '1609901155579', 3, 'ทัศนัย', 'จันทร์เรือง', '1601000071769', '0', 'ไม่ระบุ', '0', 5, 'จามรี', 'แสงโพธิ์', '1600700007582', '0', 'ไม่ระบุ', '0', 5, 'จามรี', 'แสงโพธิ์', '', '0882807086', 'เกษตรกรรม', '0'),
('9995', '1609901168379', 3, 'ธนดนัย', 'รังผึ้ง', '1180200074218', '0', 'ไม่ระบุ', '0', 5, 'อชิรญาณ์', 'ยอดนิล', '1180200081516', '0', 'ไม่ระบุ', '0', 5, 'อชิรญาณ์', 'ยอดนิล', '', '0932513565', 'เกษตรกรรม', '0'),
('9996', '1600102125174', 3, 'ธนพล', 'กลิ่นไชย', '1600100544269', '0', 'ไม่ระบุ', '0', 5, 'ศิริลักษณ์', 'สิงห์เถื่อน', '1129900287247', '0', 'ไม่ระบุ', '0', 5, 'ศิริลักษณ์', 'สิงห์เถื่อน', '', '0801186139', 'รับจ้าง', '0'),
('9997', '1609901160882', 3, 'ตรีวิทย์', 'พิริยะโภคานนท์', '3601000114031', '0', 'ไม่ระบุ', '0', 4, 'สิภาลักษณ์', 'พิริยะโภคานนท์', '5620700002231', '0', 'ไม่ระบุ', '0', 4, 'สิภาลักษณ์', 'พิริยะโภคานนท์', '', '0817779636', 'ธุรกิจส่วนตัว', '0'),
('9998', '1600102130950', 3, 'ปรีชา', 'วรผล', '5600190007252', '0', 'ไม่ระบุ', '0', 5, 'เจริญ', 'แก้วขมิ้น', '3600700750567', '0', 'ไม่ระบุ', '0', 5, 'เจริญ', 'แก้วขมิ้น', '', '0957160641', 'เกษตรกรรม', '0');
INSERT INTO `tbl_parent` (`studentID`, `PersonID`, `FatherPrefixCode`, `FatherName`, `FatherSurName`, `FatherPersonID`, `Father_tel`, `Fatheroccupa`, `FatherSalary`, `MatherPrefixCode`, `Mathername`, `Mathersurname`, `MatherPersonID`, `Mather_tel`, `Matheroccupa`, `MatherSalary`, `ParentPrefixCode`, `ParentName`, `ParentSurname`, `ParentPersonID`, `Parent_tel`, `Parentoccupa`, `ParentSalary`) VALUES
('﻿10027', '1209702959353', 3, 'วีระพล', 'กลิ่นบุญ', '1180200058000', '0', 'ไม่ระบุ', '0', 5, 'จินดาพร', 'ขวัญสงค์', '1361000114592', '0', 'ไม่ระบุ', '0', 5, 'จินดาพร', 'ขวัญสงค์', '', '0862111807', 'รับจ้าง', '0');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_parentstatus`
--

CREATE TABLE `tbl_parentstatus` (
  `ParentStatusid` int(2) NOT NULL,
  `ParentStatusName` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tbl_parentstatus`
--

INSERT INTO `tbl_parentstatus` (`ParentStatusid`, `ParentStatusName`) VALUES
(1, 'มีชีวิตอยู่'),
(2, 'เสียชีวิตแล้ว');
...
INSERT INTO `tbl_prefix` (`PrefixCode`, `PrefixName`) VALUES
(1, 'เด็กชาย'),
(2, 'เด็กหญิง'),
(3, 'นาย'),
(4, 'นาง'),
...
CREATE TABLE `tbl_religion` (
  `Religionid` int(2) NOT NULL,
  `Religionname` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tbl_religion` (`Religionid`, `Religionname`) VALUES
(1, 'พุทธ'),
(2, 'คริสต์'),
(3, 'อิสลาม');
...
INSERT INTO `tbl_semester` (`SemesterID`, `Semester`) VALUES
(1, 'ภาคเรียนที่ 1'),
(2, 'ภาคเรียนที่ 2');
...
CREATE TABLE `tbl_student` (
  ...
  `student_img` varchar(60) NOT NULL,
  `GenderCode` int(1) NOT NULL,
  `blgerid` int(2) NOT NULL,
  `student_Birthdate` varchar(10) NOT NULL,
  `Student_Nickname` varchar(15) NOT NULL,
  `Religionid` int(2) NOT NULL,
  `GradeLevel` int(2) NOT NULL,
  `groupid` varchar(3) NOT NULL,
  `EntryAcademicYear` int(4) NOT NULL,
  `AcademicYears` int(5) NOT NULL,
...
INSERT INTO `tbl_student` (`studentID`, `PersonID`, `PrefixCode`, `student_name`, `student_surname`, `student_img`, `GenderCode`, `blgerid`, `student_Birthdate`, `Student_Nickname`, `Religionid`, `GradeLevel`, `groupid`, `EntryAcademicYear`, `AcademicYears`, `Semester`, `statusid`, `stu_tel`) VALUES
('10000', '1609901147363', 2, 'ธนภร', 'บำรุงศรี', '', 2, 2, '4/11/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0857306799'),
('10002', '1609901138402', 2, 'กชนันท์', 'อินประสิทธิ์', '', 2, 1, '1/9/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0971168839'),
('10005', '1609901147932', 2, 'นรีรัตน์', 'บัวเผื่อน', '', 2, 4, '4/11/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0810405724'),
('10006', '1600102134092', 1, 'จิตติพัฒน์', 'นิลสนธิ', '', 1, 3, '20/10/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0932363411'),
('10007', '1600102129391', 2, 'ธนัญญา', 'บุญนก', '', 2, 2, '16/6/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '0872016619'),
('10008', '1609901134491', 2, 'นวพร', 'กิติฐากร', '', 2, 3, '29/7/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '0840508942'),
('10009', '1609901128881', 1, 'โรมรัชตะ', 'ทับทิมทอง', '', 1, 2, '18/6/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0850671124'),
('10010', '1609901137074', 1, 'ธนโชติ', 'รุ่งเรือง', '', 1, 2, '19/8/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0810428108'),
('10011', '1601001138514', 1, 'ชัชวาล', 'เทียนเงิน', '', 1, 2, '3/2/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '0898564179'),
('10012', '1619900608375', 2, 'วริศรา', 'จันทร์สี', '', 2, 2, '19/9/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0806843214'),
('10013', '1600102142231', 2, 'ธมลวรรณ', 'สุรนันท์ธร', '', 2, 2, '4/5/2014', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '0849121687'),
('10015', '1129701572138', 2, 'งามบุญ', 'โกนซา', '', 2, 2, '27/5/2012', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0899587960'),
('10016', '1609901144178', 2, 'ฑิตยา', 'ทองพรม', '', 2, 1, '8/10/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0896402560'),
('10017', '1609901144186', 2, 'ณธายุ', 'ทองพรม', '', 2, 4, '8/10/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0896402560'),
('10020', '1600102135595', 2, 'ชัญญา', 'นิลสนธิ', '', 2, 4, '28/11/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '086-211142'),
('10022', '1609700312871', 2, 'พัสวี', 'แก้วสี', '', 2, 2, '27/8/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0931707956'),
('10024', '1189900619410', 1, 'แสนไชย', 'ไม้ตะเภา', '', 1, 3, '11/11/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0912843904'),
('10025', '1609901167151', 2, 'มารินทร์ดา', 'สังข์ทอง', '', 2, 4, '15/4/2014', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0946362650'),
('10028', '1619900639424', 1, 'วริศ', 'วัฒนาณรงค์', '', 1, 2, '31/5/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '0821658479'),
('10029', '1103000300128', 1, 'กรจิรัชย์', 'พิริยะโภคานนท์', '', 1, 3, '20/12/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '0819727412'),
('10030', '1609700317318', 2, 'ภัทรธิดา', 'อินอิ่ม', '', 2, 4, '3/6/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '098-127585'),
('10031', '1609901172295', 1, 'ณัฐกรณ์', 'เทพนาง', '', 1, 1, '22/5/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '0946062606'),
('10032', '1609901198898', 2, 'ชัชชญา', 'เปียชวด', '', 2, 1, '28/12/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '0810442535'),
('10033', '1609901178102', 1, 'ปัณณวิชญ์', 'ตันรุ่งสุวรรณ', '', 1, 2, '14/7/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '084-002550'),
('10034', '1609901180646', 1, 'นิธิศ', 'วงษ์แก้ว', '', 1, 3, '1/8/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '091-989366'),
('10035', '1609901196003', 2, 'ณัฐพร', 'กะวะระพฤษ', '', 2, 4, '1/12/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '081-740800'),
('10036', '1600102144675', 2, 'กัลย์ญาณัฐ', 'ลอยบัณดิษฐ', '', 2, 1, '26/6/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '061-356362'),
('10037', '1609901212157', 1, 'ชิษณุพงศ์', 'สุขเสวี', '', 1, 2, '1/5/2015', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '091-838612'),
('10038', '1648900195703', 2, 'ขวัญธารา', 'พวงสมบัติ', '', 2, 3, '21/11/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '083-060018'),
('10039', '1619900654831', 1, 'กิตติธร', 'ตรงเมธี', '', 1, 4, '5/4/2015', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '081-280534'),
('10040', '1609901175278', 2, 'พณัตศศิตา', 'สิงห์เถื่อน', '', 2, 1, '21/6/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '087-200180'),
('10041', '1600102149731', 2, 'ธัญพร', 'นุชนุ่ม', '', 2, 2, '12/10/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '088-148805'),
('10042', '1609901195139', 1, 'ศุภโชค', 'สายคุณากร', '', 1, 3, '28/11/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '087-683155'),
('10043', '1609901185567', 1, 'เอื้ออังกูร', 'ศรีฉ่ำ', '', 1, 4, '11/9/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '092-554828'),
('10044', '1219901557221', 2, 'ธนิวรรณ', 'แสงสำเภา', '', 2, 1, '27/8/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '081-859299'),
('10045', '1619900642018', 1, 'นรากร', 'ป้อมเหม็ง', '', 1, 2, '27/7/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '080-045221'),
('10046', '1619900650932', 2, 'วรปภา', 'แสงสนิท', '', 2, 3, '6/1/2015', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '084-491162'),
('10047', '1609901212637', 1, 'ยศกร', 'จันทร์ลา', '', 1, 4, '7/5/2015', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '0878448669'),
('10048', '1609901175928', 1, 'ยุรนันท์', 'สิงห์เถื่อน', '', 1, 1, '26/6/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '0985855667'),
('10049', '1601001141337', 1, 'พีรพัฒน์', 'ภู่เกตุ', '', 1, 2, '12/12/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '0895630755'),
('10050', '1600102153429', 1, 'นราวิชญ์', 'ศรีเพ็ง', '', 1, 3, '21/12/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '0946914635'),
('10051', '1149901375131', 1, 'ธนดล', 'คุ้มภัย', '', 1, 4, '18/7/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '0862064628'),
('10052', '1600102152848', 1, 'ฐานพัฒน์', 'ปั้นด้วง', '', 1, 4, '9/12/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '0881620997'),
('10053', '1619900646625', 1, 'จิรชัย', 'จันทร์สี', '', 1, 1, '20/10/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '0931676743'),
('10054', '1600102144977', 2, 'ปภาดา', 'พุ่มเจริญ', '', 2, 4, '4/7/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '0949618130'),
('10055', '1600102151787', 1, 'กวินทร์', 'แรงจบ', '', 1, 1, '19/11/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '0973298203'),
('10056', '1600102157211', 1, 'ก้องภพ', 'พวงสมบัติ', '', 1, 1, '27/3/2015', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '0865897501'),
('10057', '1619900653648', 1, 'ธนศักดิ์', 'ทองอิ่ม', '', 1, 2, '6/3/2015', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '0833301008'),
('10058', '1600102155448', 2, 'ชัชณดา', 'พูลประดิษฐ', '', 2, 3, '10/2/2015', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '0892709421'),
('10059', '1600102157882', 1, 'วรินทร', 'ออระเอี่ยม', '', 1, 2, '11/4/2015', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '092-936449'),
('10060', '1601001140888', 1, 'บวรชัย', 'ไล้ทอง', '', 1, 3, '4/8/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '085-538651'),
('10061', '1609901172104', 1, 'รัชพล', 'แตงพรม', '', 1, 3, '22/5/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '080-116805'),
('10062', '1619900649730', 2, 'เนตรณภา', 'มีหวาน', '', 2, 3, '14/12/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '0810441308'),
('10063', '1609901191095', 2, 'ณฉัตร', 'แสงสุข', '', 2, 2, '27/10/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '080-925219'),
('10064', '1247400013846', 1, 'พหุสุวรรณ', 'พรหมริ้ว', '', 1, 4, '9/1/2015', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '081-045712'),
('10066', '1619900649632', 1, 'เตชภณ', 'แสงเทียนประไพ', '', 1, 3, '12/12/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '088-818247'),
('10067', '1609901195911', 1, 'ธนดล', 'บุญเกตุ', '', 1, 3, '1/12/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '085-602110'),
('10068', '1189900629407', 2, 'กชกร', 'สุวรรณ์', '', 2, 3, '28/4/2014', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 3, '087-843252'),
('10069', '1609901162656', 2, 'ญาโณทัย', 'เส็งสุข', '', 2, 4, '2/3/2014', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 3, '093-134313'),
('10070', '1619900635127', 2, 'ชญาดา', 'ขำอิง', '', 2, 1, '4/3/2014', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 3, '085-728986'),
('10071', '1609901152219', 2, 'จิราพัชร', 'อ่วมทอน', '', 2, 2, '5/12/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 3, '086-937616'),
('10072', '1189900614621', 2, 'วรวีร์', 'ด้วงไทย', '', 2, 3, '4/9/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 3, '087-527203'),
('10073', '1600102134611', 1, 'ณัฐวัฒน์', 'ฟือสันเทียะ', '', 1, 3, '4/11/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '089-957023'),
('10074', '1609901127991', 2, 'นริศรา', 'อินทร์ศักดิ์', '', 2, 3, '6/6/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 3, '093-190194'),
('10075', '1609901138879', 2, 'ณัฐณิชา', 'วรอินทร์', '', 2, 3, '30/8/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 3, '095-547211'),
('10076', '1600102139035', 2, 'จันทากานต์', 'ต่วนเทศ', '', 2, 4, '16/2/2014', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 3, '0896397025'),
('10077', '1139400078509', 2, 'ชัชญาดา', 'พูลประดิษฐ', '', 2, 3, '11/1/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 3, '089-270942'),
('10078', '1600102104517', 1, 'พิพัฒนพร', 'สีสุ่ม', '', 1, 1, '4/10/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 3, '089-860553'),
('10079', '1609901034542', 1, 'ธนพล', 'เศรษฐมูล', '', 1, 2, '3/8/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 3, '061-335930'),
('10085', '1619900606631', 2, 'เสาวลักษณ์', 'โสภาพงษ์', '', 2, 1, '13/8/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 3, '085-733363'),
('10086', '1129902406251', 2, 'ฮานัน', 'ชาเกอร์', '', 2, 4, '26/12/2013', 'ไม่ระบุ', 3, 2, '121', 1, 0, 2, 1, '082-411791'),
('10087', '1189900612377', 2, 'ปรมาภรณ์', 'มั่นพุฒ', '', 2, 3, '1/8/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 3, '084-575559'),
('10088', '1600102158561', 1, 'กชกร', 'พยัคฆเพศ', '', 1, 1, '27/4/2015', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '089-960150'),
('10089', '1609901159221', 2, 'ภิญญาพัชญ์', 'โตม่วง', '', 2, 1, '1/2/2014', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 3, '087-943801'),
('10090', '1189900651003', 1, 'ภัทราวุธ', 'พันธุ์เขตร์กิจ', '', 1, 1, '14/4/2015', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '056341522'),
('10092', '1209000638361', 2, 'พชรอร', 'คล้ายปาน', '', 2, 3, '16/1/2012', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 3, '081-740238'),
('10094', '1601001140217', 1, 'ชิษณุพงศ์', 'เลี้ยงกลับ', '', 1, 2, '23/1/2014', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 3, '092-602611'),
('10095', '1309801741576', 1, 'กิตติศักดิ์', 'เข็มอินทร์', '', 1, 2, '4/7/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '088-425081'),
('10096', '1619900609240', 2, 'กัญธิมา', 'มีมุข', '', 2, 4, '27/9/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 3, '056341522'),
('10097', '1609901032558', 2, 'ธีนิดา', 'อินมณี', '', 2, 1, '18/7/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 3, '089-961632'),
('10098', '1609901041158', 2, 'นวินตา', 'อากาศสุภา', '', 2, 2, '13/9/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 3, '083-331771'),
('10099', '1609901186474', 2, 'ณัชชา', 'ยอดนิล', '', 2, 2, '18/9/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '087-839026'),
('10100', '1419902950421', 2, 'กันยาพัฒน์', 'จันสำเภา', '', 2, 2, '25/9/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 3, '094-502956'),
('10101', '1609901182355', 1, 'ศิรชัช', 'สังข์แตง', '', 1, 3, '17/8/2014', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '090-686869'),
('10102', '1600102110860', 1, 'ก้องกิดากร', 'ก้อนทอง', '', 1, 4, '15/2/2012', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 3, '095-536579'),
('10104', '1601001136619', 1, 'นิธิกร', 'ประสพสุข', '', 1, 2, '6/1/2012', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 3, '083-956593'),
('10105', '1600102113702', 2, 'กัญญ์กุลพัชร', 'ทองเกล็ด', '', 2, 3, '10/5/2012', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 3, '064-596876'),
('10106', '1600102133274', 2, 'จารุพิชญา', 'ศรีวิระ', '', 2, 1, '1/10/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 3, '084-882194'),
('10107', '1609901060217', 2, 'มติมนต์', 'รังผึ้ง', '', 2, 4, '10/2/2012', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 3, '084-817977'),
('10108', '1600102134823', 2, 'ประภาภรณ์', 'ขาวสอาด', '', 2, 1, '10/11/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 3, '085-732770'),
('10109', '1609901206670', 1, 'ศุภกฤต', 'กิติยา', '', 1, 2, '14/3/2015', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '080-669055'),
('10112', '1209000850432', 2, 'ณัฐวลัญช์', 'กองแก้ว', '', 2, 4, '1/2/2015', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '056341522'),
('10113', '1609901180298', 1, 'อิทธิพัทธ์', 'เกิดอยู่', '', 1, 1, '29/7/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '089-590453'),
('10114', '1600102141994', 1, 'จุลจักร', 'เอี่ยมอรุณ', '', 1, 2, '1/5/2014', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 3, '097-959001'),
('10115', '1619900607115', 1, 'วัชรพล', 'อุ่นใจ', '', 1, 3, '25/8/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '086-943644'),
('10116', '1609901198855', 1, 'ณัฐกิตติ์', 'วงพินิต', '', 1, 1, '26/12/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '082-169844'),
('10117', '1601001139782', 1, 'ณัฐภัทร', 'ท่อนแก้ว', '', 1, 1, '31/10/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 3, '098-004047'),
('10118', '1209301301501', 1, 'ชัยชนะ', 'กลิ่นสุวรรณ', '', 1, 1, '12/6/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 1, '091-615827'),
('10119', '1102004633813', 2, 'ภคพร', 'ว่านวัด', '', 2, 4, '26/1/2015', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '084-940362'),
('10120', '1189900627285', 2, 'ศิริกัญญา', 'ไทยโอสถ', '', 2, 1, '25/3/2014', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 3, '094-735518'),
('10121', '1189900630952', 1, 'ภูมิรพี', 'แจ่มมณี', '', 1, 4, '22/5/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '081-851831'),
('10122', '1189900592350', 1, 'ศิวกร', 'นิลสุ่ม', '', 1, 1, '29/9/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 3, '081-886231'),
('10123', '1209601791686', 1, 'พงศ์พล', 'เพ็งคำ', '', 1, 2, '24/9/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 3, '094-442022'),
('10124', '1600102112480', 1, 'รัชชานนท์', 'อยู่โพธิ์', '', 1, 4, '27/3/2012', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 3, '094-357574'),
('10126', '1600102146872', 1, 'ปุญญพัทธ์', 'เพ็ชรชนะ', '', 1, 4, '16/8/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '085-725123'),
('10128', '1619900585405', 2, 'กนกพร', 'คำเหล็ก', '', 2, 3, '23/7/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '086-930809'),
('10129', '1619900647753', 1, 'ดุษฎี', 'ธาวุฒิสกุล', '', 1, 2, '5/11/2014', 'ไม่ระบุ', 1, 1, '112', 1, 0, 2, 3, '056-380168'),
('10130', '1189900645798', 2, 'ธนพร', 'กันสุข', '', 2, 2, '5/1/2015', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '097-923481'),
('10131', '1600102128815', 2, 'ชนัญญา', 'อิ่มเนย', '', 2, 2, '21/5/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 3, '084-380460'),
('10132', '1609901143988', 1, 'ภูริณัฐ', 'สาครสิทธิ์', '', 1, 3, '10/10/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 3, '063-802781'),
('10133', '1609901103927', 1, 'ปีติภัทร', 'ไพรสุข', '', 1, 3, '5/12/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 3, '089-075559'),
('9682', '1102004219600', 1, 'ดลรวีย์', 'นกครุฑ', '', 1, 2, '7/12/2010', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '083-875-30'),
('9684', '1103200226924', 2, 'ลภัสรดา', 'สาเสน', '', 2, 1, '13/10/2010', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '086-085-48'),
('9686', '1100202068525', 1, 'พัชรพล', 'พุทธรักษา', '', 1, 4, '11/4/2011', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '089-444-42'),
('9688', '1609900984521', 1, 'ยศพนธ์', 'แก่นเขียว', '', 1, 3, '12/7/2010', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '087-810-15'),
('9690', '1600102091091', 1, 'พิพรรธ', 'รอดสัมฤทธิ์', '', 1, 2, '13/11/2010', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '083-955-82'),
('9691', '1600102095399', 1, 'ธนโชติ', 'ทองคำ', '', 1, 1, '8/2/2011', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '087-850-03'),
('9695', '1600102087426', 1, 'นิพิฐพนธ์', 'โพธิ์ประจักร์', '', 1, 4, '15/9/2010', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '086-216-65'),
('9699', '1104301311201', 2, 'ลฎาภา', 'เกษมสานต์', '', 2, 3, '19/1/2011', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '086-216-65'),
('9703', '1601001134624', 1, 'รชต', 'สร้อยประดิษฐ์', '', 1, 2, '11/12/2010', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '089-782-65'),
('9710', '1600102092250', 1, 'กันตภัทร์', 'ชาลีนิวัฒน์', '', 1, 1, '5/12/2010', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '080-681-93'),
('9729', '1609900986159', 2, 'ศศิภัค', 'ยอดนิล', '', 2, 3, '30/7/2010', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '086-214-46'),
('9730', '1600102091636', 2, 'อรัญญา', 'รักประกอบ', '', 2, 2, '25/11/2010', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '082-168-68'),
('9731', '1601001134853', 2, 'ชุติมา', 'คงบัวภา', '', 2, 1, '21/1/2011', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '084-926-31'),
('9741', '1619900577925', 2, 'มัณยาภา', 'ศรีนุช', '', 2, 1, '23/2/2011', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '092-193-65'),
('9746', '1601001134306', 1, 'กฤษฎิ์', 'รุ่งศิริรัตน์', '', 1, 4, '30/9/2010', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '086-214-78'),
('9751', '1149901176040', 1, 'สิรวิชญ์', 'ศรีเพ็ง', '', 1, 4, '7/9/2010', 'ไม่ระบุ', 0, 5, 'ป.2', 1, 0, 2, 1, '094-642-61'),
('9784', '1609901018083', 2, 'ณิชกมล', 'ทองเกล็ด', '', 2, 3, '7/4/2011', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '0862051845'),
('9785', '1609901058654', 2, 'กานต์ชนิต', 'ดอกกระทุ่ม', '', 2, 1, '27/1/2012', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0852693955'),
('9786', '1609901071090', 1, 'ปริญญา', 'สร้อยจู', '', 1, 2, '29/4/2012', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0852721754'),
('9791', '1600200128291', 2, 'โฆษิตา', 'มาลาศรี', '', 2, 4, '17/12/2010', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '0946011033'),
('9792', '1200901621133', 1, 'ชัยอนันต์', 'ทันบำรุง', '', 1, 3, '24/6/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0846577732'),
('9793', '1609901039081', 2, 'วิชากร', 'ตรีนิตย์', '', 2, 1, '29/8/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0800262010'),
('9795', '1609901033317', 2, 'สุนิษา', 'ทันบำรุง', '', 2, 2, '22/7/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0800516443'),
('9796', '1601001136503', 1, 'ภัทรพงศ์', 'แก้วแวว', '', 1, 1, '26/12/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0895643792'),
('9797', '1849300166132', 1, 'วีรภัทร', 'วัตถุสินธุ์', '', 1, 2, '16/1/2012', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0871182928'),
('9798', '1629900964601', 2, 'เบญญทิพย์', 'ทองเสงี่ยม', '', 2, 3, '24/11/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0966186727'),
('9799', '1609901053555', 1, 'ธนกร', 'สุ่มประดิษฐ์', '', 1, 4, '19/12/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0845985974'),
('9800', '1600102092535', 2, 'ภัทรวดี', 'จั่นฤทธิ์', '', 2, 1, '8/12/2010', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '0862088090'),
('9802', '1619900583551', 2, 'ตีรณา', 'นิลสนธิ', '', 2, 1, '21/6/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0866368279'),
('9806', '1609901050734', 1, 'พงศภัค', 'ทรัพย์ขำ', '', 1, 2, '2/12/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0828831716'),
('9811', '1609901038548', 2, 'เอรายา', 'วงษ์พันธ์', '', 2, 1, '25/8/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0862165256'),
('9812', '1609901029409', 2, 'ปวริศรา', 'ปาระมีศรี', '', 2, 2, '28/6/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0806872588'),
('9813', '1199901368992', 2, 'ชนิดาภา', 'ดำรงรักษ์', '', 2, 3, '17/6/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0890003689'),
('9815', '1609901054284', 2, 'วรรณพร', 'สิงห์ประเสริฐ', '', 2, 3, '26/12/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0872028774'),
('9816', '1619900585979', 1, 'เอื้ออังกูร', 'คำสุข', '', 1, 4, '3/8/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0898565684'),
('9818', '1600102088295', 1, 'อาทิวราห์', 'จันทา', '', 1, 4, '29/9/2010', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '0842354996'),
('9819', '1601001135736', 2, 'กัญญาณัฐ', 'วรอินทร์', '', 2, 1, '28/7/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0862113112'),
('9823', '1600102103952', 1, 'ปุณณวิช', 'อินประสิทธิ์', '', 1, 3, '22/9/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0810418574'),
('9824', '1188500000756', 1, 'วีรภัทร', 'อินทร์ประสิทธิ์', '', 1, 4, '21/1/2012', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0878422099'),
('9827', '1609901037258', 1, 'คงศักดิ์', 'พระทัย', '', 1, 1, '19/8/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0895688860'),
('9828', '1619900587629', 2, 'ธนาภา', 'อำพันทอง', '', 2, 2, '4/9/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0909451404'),
('9829', '1600102108431', 2, 'รวิสรา', 'ศรีคงไทย', '', 2, 1, '14/12/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0895645028'),
('9830', '1179900559565', 1, 'โรมรัตนะ', 'ทับทิมทอง', '', 1, 3, '31/10/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0850671124'),
('9832', '1609901041867', 2, 'พิมพ์มาดา', 'วัตสุข', '', 2, 2, '16/9/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0846242162'),
('9835', '1600102099858', 1, 'พีรพัฒน์', 'ชาลีนิวัฒน์', '', 1, 4, '8/6/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0852696936'),
('9837', '1168300145955', 2, 'ฐิติกานต์', 'จันทร์ลา', '', 2, 1, '26/10/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0878448669'),
('9838', '1619900597942', 2, 'ชนิตรา', 'พวงสมบัติ', '', 2, 3, '6/3/2012', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0819534804'),
('9841', '1609901023851', 2, 'อินทิรา', 'ทับทิมศรี', '', 2, 2, '18/5/2011', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '0904576518'),
('9842', '1601001135167', 1, 'ปฐมพงษ์', 'ฤทธิไกร', '', 1, 2, '28/3/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0826639101'),
('9845', '1600102096816', 1, 'รัฐภาคย์', 'แว่นแก้ว', '', 1, 3, '17/3/2011', 'ไม่ระบุ', 1, 5, 'ป.2', 1, 0, 2, 1, '0862127876'),
('9853', '1305300075782', 1, 'แทนคุณ', 'พิมแก้ว', '', 1, 3, '14/2/2012', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0884250819'),
('9855', '1101700520714', 1, 'เอื้ออังกูร', 'เปรมสุข', '', 1, 4, '29/2/2012', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0867830582'),
('9856', '1319800650917', 1, 'สิทธิชัย', 'สกุลไทย', '', 1, 1, '8/5/2012', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0892145031'),
('9858', '1600102107257', 2, 'วาณกา', 'รูปจันทร์', '', 2, 2, '17/11/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0848226460'),
('9861', '1609901037584', 2, 'สุพิชญา', 'คอนทองคำ', '', 2, 3, '19/8/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0910254788'),
('9862', '1609901041590', 1, 'ณัฐดนัย', 'สิงหนาท', '', 1, 4, '12/9/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0818219507'),
('9863', '1189900571824', 2, 'ภคมน', 'น้อยเจริญ', '', 2, 1, '5/12/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0872017262'),
('9870', '1601001136597', 1, 'นราพันธ์', 'สนทอง', '', 1, 2, '31/12/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '-'),
('9874', '1139400066055', 1, 'อัครวินท์', 'มากบุญ', '', 1, 4, '10/11/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0862656812'),
('9878', '1600102099785', 2, 'ชนันธร', 'นิลสนธิ', '', 2, 4, '6/6/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0862111424'),
('9884', '1529902531826', 2, 'ณัฎฐธิดา', 'คชาชาญ', '', 2, 1, '25/7/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0850541183'),
('9885', '1609901114431', 1, 'วธกร', 'ลอยเมฆ', '', 1, 1, '27/2/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '0811463194'),
('9886', '1609901082334', 1, 'ธฤตภน', 'มั่นศักดิ์', '', 1, 1, '23/7/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '096-269522'),
('9887', '1609901089657', 2, 'นิชากานต์', 'สิงห์เถื่อน', '', 2, 1, '8/9/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '085-601511'),
('9888', '1609901074471', 2, 'อภิสรา', 'แดนนาสาร', '', 2, 2, '29/5/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '089-269016'),
('9890', '1209702805895', 1, 'จิรายุทธ', 'อุตศาสตร์', '', 1, 4, '20/4/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '061-810460'),
('9891', '1600102119271', 2, 'ณิชาภัทร', 'ลอยบัณดิษฐ', '', 2, 4, '23/9/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '086-943644'),
('9892', '1600102124704', 2, 'สุมนทิพย์', 'นิลสนธิ', '', 2, 4, '31/1/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '080-688844'),
('9893', '1619900619113', 1, 'อินทัช', 'นาคแจ้ง', '', 1, 4, '10/4/2013', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0890733192'),
('9894', '1609901122913', 1, 'ปุญญพัฒน์', 'สมพร', '', 1, 2, '4/5/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '0810431045'),
('9896', '1601001138875', 2, 'ธาลิน', 'พันธ์สิงห์', '', 2, 2, '6/5/2013', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0912071127'),
('9897', '1600102106153', 1, 'พุทธิพงศ์', 'แว่นแก้ว', '', 1, 1, '28/10/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '089-859707'),
('9898', '1601001138964', 1, 'พัชรพล', 'ปานอุทัย', '', 1, 3, '14/5/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '0878384928'),
('9899', '1600102120750', 1, 'ธรรมสรณ์', 'อิ่มอยู่', '', 1, 3, '23/10/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0999043543'),
('9902', '1609901118801', 2, 'ธัญญาภรณ์', 'พวงสมบัติ', '', 2, 3, '2/4/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '083-718320'),
('9904', '1601001138115', 2, 'วรรณภา', 'มีมุข', '', 2, 4, '24/10/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0862163495'),
('9905', '1529902533691', 1, 'กันทรากร', 'จันทร์แพ', '', 1, 2, '10/8/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0872043416'),
('9906', '1600102123767', 1, 'จิรายุ', 'คงมี', '', 1, 3, '11/1/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '086-199133'),
('9908', '1600102101721', 1, 'กลทีบ์', 'มั่นศักดิ์', '', 1, 3, '27/7/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '0845918922'),
('9910', '1600102117066', 1, 'ธนากฤต', 'คำเรืองศรี', '', 1, 1, '1/8/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '0979694013'),
('9911', '1609901112675', 2, 'ธิมาพร', 'โตเกิด', '', 2, 2, '14/2/2013', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0613519026'),
('9912', '1609700309927', 2, 'คชาภร', 'โพธิ์ป้อม', '', 2, 3, '9/3/2013', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0899594016'),
('9913', '1609901086321', 1, 'ปิติภัทร', 'ศรีธิธง', '', 1, 2, '15/8/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0871994043'),
('9914', '1729900925221', 1, 'กรวิชญ์', 'โนรี', '', 1, 1, '2/6/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '086-204173'),
('9917', '1102004366475', 1, 'ศุภณัฐ', 'โพธิ์ทอง', '', 1, 2, '7/6/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0851143836'),
('9918', '1609901085341', 2, 'นิชาภา', 'ผูกพันธ์', '', 2, 1, '12/8/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '0878431373'),
('9919', '1600102118127', 2, 'วาสนา', 'สนประเสริฐ', '', 2, 4, '29/8/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '082-771726'),
('9920', '1600102119883', 2, 'พิชญานันต์', 'มั่นทอง', '', 2, 1, '5/10/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0875213791'),
('9921', '1300101311821', 2, 'นริศรา', 'ศิริสวัสดิ์', '', 2, 1, '26/5/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '089-272349'),
('9922', '1609901114902', 1, 'วงศกร', 'เย็นสุข', '', 1, 2, '4/3/2013', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '083-218833'),
('9923', '1609901104508', 2, 'สุวิชญา', 'คงชิต', '', 2, 2, '14/12/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0871979758'),
('9924', '1609901100855', 2, 'ธรรศพร', 'ศรีศุภรพันธ์', '', 2, 4, '19/11/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '056-341182'),
('9925', '1209702754948', 2, 'วณิชย์ชญา', 'บุตรดี', '', 2, 1, '6/9/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '089-035258'),
('9929', '1600102121098', 1, 'ธนาภพ', 'พุกทอง', '', 1, 1, '4/11/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '097-928245'),
('9933', '1609901111725', 2, 'ณัฐชยา', 'บุญมา', '', 2, 2, '7/2/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '0849375594'),
('9935', '1609901074714', 1, 'ฐิติคุณ', 'น้อยสวัสดิ์', '', 1, 4, '23/5/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '0855936431'),
('9936', '1609901093425', 2, 'พัชรธิดา', 'สินเภตรา', '', 2, 2, '2/10/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '084-820323'),
('9937', '1600102125387', 2, 'ปภาวดี', 'คนตรง', '', 2, 2, '28/2/2013', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '084-777806'),
('9940', '1749700198997', 1, 'อาทิตย์', 'ผันสนาม', '', 1, 2, '28/10/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '088-458473'),
('9941', '1189900596673', 2, 'มณิภา', 'โตอิ้ม', '', 2, 3, '29/11/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '082-877032'),
('9942', '1600102105416', 1, 'ณัฐวุฒิ', 'บำรุงศรี', '', 1, 1, '20/10/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0906899342'),
('9943', '1609901111334', 1, 'สรายุ', 'ขำเมฆ', '', 1, 1, '1/2/2013', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0813439068'),
('9946', '1600102126065', 2, 'สุภัสสรา', 'อินแสงแวง', '', 2, 2, '20/3/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '089-208108'),
('9951', '1609901115623', 1, 'ภัคอนันต์', 'จันทร์สร้อย', '', 1, 4, '6/3/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '089-789472'),
('9952', '1609901081338', 1, 'ยุทธนา', 'อภิชาติ', '', 1, 3, '14/7/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0932354693'),
('9953', '1609901109577', 2, 'ม่านไหม', 'เอี่ยมสอาด', '', 2, 4, '16/1/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '083-316598'),
('9954', '1600102107371', 2, 'ศิรภัสสร', 'พรมจีน', '', 2, 2, '19/11/2011', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '0848192377'),
('9956', '1600102128149', 1, 'ฤทธิชัย', 'รอดเฉลิม', '', 1, 4, '12/5/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '082-887038'),
('9958', '1189900586741', 2, 'อารดา', 'อ่อนสอาด', '', 2, 1, '17/7/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '086-206996'),
('9960', '1600102112145', 1, 'กณวรรธน์', 'ฤทธิ์ทอง', '', 1, 1, '18/3/2012', 'ไม่ระบุ', 1, 4, '212', 1, 0, 2, 1, '061-807197'),
('9962', '1609901081931', 1, 'อนาวิน', 'แตงพรม', '', 1, 3, '17/7/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '087-825082'),
('9963', '1609901125459', 1, 'ธนวรรษน์', 'ทับทิมศรี', '', 1, 1, '20/5/2013', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0871961921'),
('9964', '1129902377391', 2, 'วิชุดา', 'โสดแสง', '', 2, 1, '25/5/2013', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0822606602'),
('9965', '1601001139715', 2, 'ธีราภรณ์', 'ศรีนุช', '', 2, 3, '16/10/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '0987910237'),
('9966', '1609901141501', 2, 'อชิรญาณ์', 'ผิวอ่อน', '', 2, 2, '19/9/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '0818864407'),
('9967', '1600102136711', 2, 'สุพัตรา', 'นิลสนธิ', '', 2, 3, '30/12/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '0806888449'),
('9968', '1103704797518', 2, 'ณัฐชารีย์', 'จันทร์ประสาท', '', 2, 4, '3/9/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '0810421494'),
('9969', '1600102117481', 1, 'กุลกีรติ', 'ชุณหเมธาทิพย์', '', 1, 3, '15/8/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0877952463'),
('9970', '1609901119572', 2, 'พชรกมล', 'เกิดศิริ', '', 2, 1, '8/4/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '0979239381'),
('9971', '1247400011258', 2, 'พรรวินท์', 'พรหมริ้ว', '', 2, 1, '23/7/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '0810457124'),
('9972', '1619900633761', 2, 'ณิชาภัทร', 'บำรุงศรี', '', 2, 2, '28/1/2014', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '0821609282'),
('9975', '1219901503520', 2, 'ชนัญชิฎา', 'ปานศักดิ์', '', 2, 1, '--544', 'ไม่ระบุ', 1, 2, '121', 1, 1, 2, 1, '0897473028'),
('9976', '1500401227298', 1, 'วัชรกร', 'ชัยรัตนรุ่งโรจน์', '', 1, 1, '16/1/2014', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0614463279'),
('9979', '1170601295746', 1, 'ปิติคุณ', 'แก้วรักษา', '', 1, 3, '6/12/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0872071105'),
('9980', '1409904262335', 1, 'เกียรติภูมิ', 'มีอาษา', '', 1, 2, '21/11/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '0992986584'),
('9981', '1609901163831', 2, 'กุลจิรา', 'ศรีฉ่ำ', '', 2, 3, '16/3/2014', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '0831652918'),
('9982', '1601001139243', 1, 'ธีรศักดิ์', 'สง่างาม', '', 1, 3, '29/6/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0930364794'),
('9983', '1600102131573', 2, 'กัญญาวัชร์', 'กัลยาณ์พัฒนกุล', '', 2, 4, '26/8/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0897053214'),
('9984', '1600102120610', 2, 'อุบลวรรณ', 'นิลสนธิ', '', 2, 1, '21/10/2012', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '0937712422'),
('9986', '1609901168557', 1, 'กิตติทัต', 'พุ่มศรี', '', 1, 2, '25/4/2014', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '0862160991'),
('9987', '1609901160050', 2, 'กัญญาภัทร', 'ดีฉนวน', '', 2, 2, '8/2/2014', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '0992924060'),
('9989', '1609901117588', 2, 'ธนภชสร', 'เพ็ชรโต', '', 2, 2, '25/3/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '0931375727'),
('9990', '1619900633787', 1, 'กันต์ณภัทร', 'ทองทุ่งโป่ง', '', 1, 1, '29/1/2014', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '0845770929'),
('9991', '1601001139669', 2, 'ปพิชญา', 'ขอนทอง', '', 2, 1, '27/9/2013', 'ไม่ระบุ', 1, 2, '121', 1, 0, 2, 1, '0810370028'),
('9992', '1600102101623', 2, 'ลภัสรดา', 'พวงสมบัติ', '', 2, 1, '25/7/2011', 'ไม่ระบุ', 1, 4, '211', 1, 0, 2, 1, '087-844055'),
('9993', '1609901103676', 1, 'ธนภัสสร์', 'สิงห์เถื่อน', '', 1, 2, '10/12/2012', 'ไม่ระบุ', 1, 3, '132', 1, 0, 2, 1, '0873103613'),
('9994', '1609901155579', 1, 'กิตติพัชญ์', 'จันทร์เรือง', '', 1, 2, '3/1/2014', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0882807086'),
('9995', '1609901168379', 2, 'ธัญชนก', 'ยอดนิล', '', 2, 1, '21/4/2014', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0857263018'),
('9996', '1600102125174', 2, 'ศุตราพรรณ', 'สิงห์เถื่อน', '', 2, 3, '21/2/2013', 'ไม่ระบุ', 1, 3, '131', 1, 0, 2, 1, '0801186139'),
('9997', '1609901160882', 2, 'กมลทิพย์', 'พิริยะโภคานนท์', '', 2, 4, '16/2/2014', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0641672999'),
('9998', '1600102130950', 1, 'ณัฎฐากร', 'วรผล', '', 1, 3, '4/8/2013', 'ไม่ระบุ', 1, 2, '122', 1, 0, 2, 1, '0957160641'),
('﻿10027', '1209702959353', 2, 'จารุพิชญา', 'กลิ่นบุญ', '', 2, 1, '24/2/2015', 'ไม่ระบุ', 1, 1, '111', 1, 0, 2, 3, '0810363993');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_studentstatus`
--
...
--
-- Dumping data for table `tbl_studentstatus`
--

INSERT INTO `tbl_studentstatus` (`statusid`, `Statusname`) VALUES
(1, 'ศึกษาอยู่'),
(2, 'จบการศึกษา'),
(3, 'นักเรียนเข้าใหม่');
...
CREATE TABLE `tbl_teacher` (
  ...
  `Teacher_img` varchar(60) NOT NULL,
  `GenderCode` int(1) NOT NULL,
...
INSERT INTO `tbl_teacher` (`TeacherID`, `PersonID`, `PrefixCode`, `name`, `surname`, `Teacher_img`, `GenderCode`, `WorkDate`, `PositionID`, `tel`, `email`) VALUES
('5', '5', 3, 'วะสัน', 'เทียนชัย2', 'ครูวะสันคอมพิวเตอร์.png', 1, '2018-08-20', 1, '0860229450', 'kruwasan2015@gmail.com');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_teacheraddress`
--

CREATE TABLE `tbl_teacheraddress` (
  `TeacherID` varchar(5) NOT NULL,
  `PersonID` varchar(13) NOT NULL,
  `HomeID` varchar(11) NOT NULL,
  `HouseNo` varchar(10) NOT NULL,
...
--
-- Dumping data for table `tbl_teacheraddress`
--

INSERT INTO `tbl_teacheraddress` (`TeacherID`, `PersonID`, `HomeID`, `HouseNo`, `moo`, `street`, `DISTRICT_ID`, `AMPHUR_ID`, `PROVINCE_ID`, `ZipCode`) VALUES
('5', '5', '1', '999999', '55', '101/53', 113, 189, 16, '60130');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_teacheraward`
--

CREATE TABLE `tbl_teacheraward` (
  `AwardID` int(5) NOT NULL,
  `AwardYear` int(4) NOT NULL,
  `AwardSemester` int(1) NOT NULL,
  `AwardName` char(120) NOT NULL,
  `AwardDetail` varchar(150) NOT NULL,
  `AwardPic` varchar(255) DEFAULT NULL,
  `AwardDate` date NOT NULL,
  `AwardBy` char(80) NOT NULL,
  `TeacherID` varchar(5) NOT NULL,
...
--
-- Dumping data for table `tbl_teacheraward`
--

INSERT INTO `tbl_teacheraward` (`AwardID`, `AwardYear`, `AwardSemester`, `AwardName`, `AwardDetail`, `AwardPic`, `AwardDate`, `AwardBy`, `TeacherID`, `AwardTypeID`) VALUES
(1, 1, 1, '1', '<p>10141</p>\r\n', '18056898_1438135599541901_4846138602896472409_n.jpg', '2018-08-21', '1414', '111', 1),
(2, 1, 2, '111111111', '<p>55</p>\r\n', '18076868_1438135796208548_3876717737359273463_o.jpg', '2018-08-13', '6666', '111', 1);
...
INSERT INTO `tbl_user` (`username`, `password`, `user_name`, `usertypeid`) VALUES
('admin', '21232f297a57a5a743894a0e4a801fc3', 'พลศรุต', '111');
...
CREATE TABLE `tbl_userlog` (
  `userlogno` int(10) NOT NULL,
  `username` varchar(30) NOT NULL,
  `useraction` varchar(30) NOT NULL,
...
INSERT INTO `tbl_userlog` (`userlogno`, `username`, `useraction`, `datetime`) VALUES
(1, 'admin', 'LOG IN', '2018-08-24 16:54:48'),
(2, 'admin', 'LOG IN', '2018-08-24 17:00:14'),
(3, 'admin', 'LOG OUT', '2018-08-24 17:00:54'),
(4, 'admin', 'LOG IN', '2018-08-24 17:05:29'),
(5, 'admin', 'LOG OUT', '2018-08-25 04:27:40'),
(6, 'admin', 'LOG IN', '2018-08-25 04:27:45'),
(7, 'admin', 'LOG OUT', '2018-08-25 05:39:32'),
(8, 'user', 'LOG IN', '2018-08-25 05:39:39'),
(9, 'user', 'LOG OUT', '2018-08-25 05:58:12'),
(10, 'admin', 'LOG IN', '2018-08-25 05:58:21'),
(11, 'admin', 'LOG IN', '2018-08-25 12:59:00'),
(12, 'admin', 'LOG OUT', '2018-09-01 09:36:45'),
(13, 'admin', 'LOG IN', '2018-09-01 10:01:23'),
(14, 'admin', 'LOG IN', '2018-09-28 16:30:49'),
(15, 'admin', 'LOG IN', '2018-10-12 12:35:12'),
(16, 'admin', 'LOG OUT', '2018-10-13 07:13:21'),
(17, 'admin', 'LOG IN', '2018-10-13 14:40:56'),
(18, 'admin', 'LOG OUT', '2018-10-21 07:48:01'),
(19, 'admin', 'LOG IN', '2018-10-21 07:48:07'),
(20, 'admin', 'LOG OUT', '2018-10-25 09:33:31'),
(21, 'user', 'LOG IN', '2018-10-25 09:33:37'),
(22, 'user', 'LOG OUT', '2018-10-25 09:33:47'),
(23, 'admin', 'LOG IN', '2018-10-25 09:33:53'),
(24, 'admin', 'LOG OUT', '2018-10-25 12:23:30'),
(25, 'user', 'LOG IN', '2018-10-25 12:23:36'),
(26, 'user', 'LOG OUT', '2018-10-25 12:23:40'),
(27, 'admin', 'LOG IN', '2018-10-25 12:23:45'),
(28, 'admin', 'LOG IN', '2018-10-29 10:58:05'),
(29, 'admin', 'LOG IN', '2018-11-30 13:30:46'),
(30, 'admin', 'LOG OUT', '2018-12-20 08:40:39'),
(31, 'admin', 'LOG IN', '2018-12-20 08:41:29'),
(32, 'admin', 'LOG IN', '2019-01-04 12:37:52'),
(33, 'admin', 'LOG IN', '2019-01-04 17:36:53'),
(34, 'admin', 'LOG OUT', '2019-01-13 11:10:16'),
(35, 'admin', 'LOG IN', '2019-01-13 11:10:20'),
(36, 'admin', 'LOG OUT', '2019-01-13 11:11:03'),
(37, 'admin', 'LOG IN', '2019-01-13 11:11:22'),
(38, 'admin', 'LOG IN', '2019-01-23 12:03:31'),
(39, 'admin', 'LOG OUT', '2019-01-23 12:03:35'),
(40, 'admin', 'LOG IN', '2019-01-23 13:52:30'),
(41, 'admin', 'LOG IN', '2019-02-01 03:49:36');
...
ALTER TABLE `tbl_academicyears`
  ADD PRIMARY KEY (`AcademicYearsID`);

--
-- Indexes for table `tbl_address`
--
ALTER TABLE `tbl_address`
  ADD PRIMARY KEY (`studentID`,`Homeid`);
...
--
-- Indexes for table `tbl_awardtype`
--
ALTER TABLE `tbl_awardtype`
  ADD PRIMARY KEY (`AwardTypeID`);

--
-- Indexes for table `tbl_blger`
--
ALTER TABLE `tbl_blger`
  ADD PRIMARY KEY (`blgerid`);

--
-- Indexes for table `tbl_classlevel`
--
ALTER TABLE `tbl_classlevel`
  ADD PRIMARY KEY (`classlevelid`);
...
--
-- Indexes for table `tbl_dutyyear`
--
ALTER TABLE `tbl_dutyyear`
  ADD PRIMARY KEY (`dutyyearID`);
...
ALTER TABLE `tbl_parent`
  ADD PRIMARY KEY (`studentID`,`FatherPersonID`);

--
-- Indexes for table `tbl_parentstatus`
--
ALTER TABLE `tbl_parentstatus`
  ADD PRIMARY KEY (`ParentStatusid`);
...
ALTER TABLE `tbl_student`
  ADD PRIMARY KEY (`studentID`,`PersonID`);

--
-- Indexes for table `tbl_studentstatus`
--
ALTER TABLE `tbl_studentstatus`
...
--
-- Indexes for table `tbl_teacheraddress`
--
ALTER TABLE `tbl_teacheraddress`
  ADD PRIMARY KEY (`TeacherID`,`HomeID`);

--
-- Indexes for table `tbl_teacheraward`
--
ALTER TABLE `tbl_teacheraward`
  ADD PRIMARY KEY (`AwardID`);
...
--
ALTER TABLE `tbl_academicyears`
  MODIFY `AcademicYearsID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `tbl_award`
--
ALTER TABLE `tbl_award`
  MODIFY `AwardID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT for table `tbl_awardtype`
--
ALTER TABLE `tbl_awardtype`
  MODIFY `AwardTypeID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tbl_blger`
--
ALTER TABLE `tbl_blger`
  MODIFY `blgerid` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tbl_classlevel`
--
ALTER TABLE `tbl_classlevel`
  MODIFY `classlevelid` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `tbl_duty`
--
ALTER TABLE `tbl_duty`
  MODIFY `dutyID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `tbl_dutyyear`
--
ALTER TABLE `tbl_dutyyear`
  MODIFY `dutyyearID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `tbl_gender`
--
ALTER TABLE `tbl_gender`
  MODIFY `GenderCode` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tbl_parentstatus`
--
ALTER TABLE `tbl_parentstatus`
  MODIFY `ParentStatusid` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tbl_position`
--
ALTER TABLE `tbl_position`
  MODIFY `PositionID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tbl_prefix`
--
ALTER TABLE `tbl_prefix`
  MODIFY `PrefixCode` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `tbl_religion`
--
ALTER TABLE `tbl_religion`
  MODIFY `Religionid` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tbl_semester`
--
ALTER TABLE `tbl_semester`
  MODIFY `SemesterID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tbl_studentstatus`
--
ALTER TABLE `tbl_studentstatus`
  MODIFY `statusid` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tbl_teacheraward`
--
ALTER TABLE `tbl_teacheraward`
  MODIFY `AwardID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tbl_userlog`
--
ALTER TABLE `tbl_userlog`
  MODIFY `userlogno` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
