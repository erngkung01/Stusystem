...
--
-- Host: localhost
-- Generation Time: Oct 24, 2018 at 02:35 PM
...
INSERT INTO `tbl_address` (`studentID`, `PersonID`, `Homeid`, `moo`, `street`, `DISTRICT_ID`, `AMPHUR_ID`, `PROVINCE_ID`, `ZipCode`, `stu_gps`) VALUES
('10027', '1209702959353', '39/1', '6', '101/53', 6180, 692, 47, '60130', '-'),
('10028', '1619900639424', '35/2', '2', '-', 6187, 692, 47, '60130', '-'),
('222222', '22222', '1', '1', '1', 1, 1, 1, '1', '1'),
('555', '555', '4444444444', '44', '44', 119, 206, 18, '4444', ''),
('99', '99', '', '', '2', 2, 0, 0, '', '');
...
INSERT INTO `tbl_parent` (`studentID`, `PersonID`, `FatherPrefixCode`, `FatherName`, `FatherSurName`, `Father_tel`, `Fatheroccupa`, `FatherSalary`, `MatherPrefixCode`, `Mathername`, `Mathersurname`, `Mather_tel`, `Matheroccupa`, `MatherSalary`, `ParentPrefixCode`, `ParentName`, `ParentSurname`, `Parent_tel`, `Parentoccupa`, `ParentSalary`) VALUES
('10027', '1209702959353', 3, 'วีระพล', 'กลิ่นบุญ', '0810363993', '-', '0', 5, 'จินดาพร', 'ขวัญสงค์', '-', '-', '0', 5, 'จินดาพร', 'ขวัญสงค์', '-', '-', '0'),
('10028', '1619900639424', 3, 'นครินทร์', 'วัฒนาณรงค์', '0821658479', '-', '0', 4, 'ดวงกมล', 'ศรีทับทิม', '-', '-', '0', 4, 'ดวงกมล', 'ศรีทับทิม', '-', '-', '0'),
('222222', '222222', 2, '2', '2', '2', '2', '2', 2, '2', '2', '2', '2', '2', 2, '2', '2', '2', '2', '2'),
('99', '99', 0, '', '', '', '', '', 0, '', '', '', '', '', 0, '', '', '', '', '');
...
('10028', '1619900639424', 1, 'วริศ ', 'วัฒนาณรงค์', '205.png', 1, 1, '3100-07-09', 'ไตตั่น', 1, 1, '111', 6, 1, 1, 1, '-'),
('222222', '222222', 1, '7', '7', '11949470_929000247165369_932249585669344706_n.jpg', 1, 1, '0000-00-00', '1', 1, 1, '1', 1, 2, 2, 2, '2'),
('44444444', '44444444', 1, '7', '7', '', 1, 1, '0000-00-00', '1', 1, 1, '1', 1, 1, 1, 1, '1'),
('99', '99', 2, '2', '2', '', 2, 2, '0000-00-00', '2', 2, 2, '2', 2, 2, 0, 0, '');
...
('5', '5', 3, 'วะสัน', 'เทียนชัย', 'ครูวะสันคอมพิวเตอร์.png', 1, '2018-08-20', 1, '0860229450', 'kruwasan2015@gmail.com');
...
INSERT INTO `tbl_teacheraddress` (`TeacherID`, `PersonID`, `Homeid`, `moo`, `street`, `DISTRICT_ID`, `AMPHUR_ID`, `PROVINCE_ID`, `ZipCode`) VALUES
('1', '1', '1', '1', '1', 123, 215, 19, '1'),
('111', '1111', '111111', '11', '1111', 115, 202, 17, '11111'),
('2', '2', '2', '2', '2', 115, 202, 17, '2'),
('333', '333333', '1', '1', '1', 113, 189, 16, '1'),
('5', '5', '1', '1', '2', 115, 202, 17, '22');
...
(3, 1, 1, '1', '<p>1</p>\r\n', 'อนุบาล3-2ครูน้องใหม่.png', '2018-07-30', '555', '5', 1);
...
INSERT INTO `tbl_user` (`userid`, `username`, `password`, `user_name`, `usertypeid`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'พลศรุต', '111'),
(2, 'student', 'student', 'นักเรียน', '444'),
(113, '2222222', '555', '555', '444'),
(114, 'user', 'ee11cbb19052e40b07aac0ca060c23ee', 'user', '222');
...
--
ALTER TABLE `tbl_award`
  MODIFY `AwardID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
...
--
ALTER TABLE `tbl_user`
  MODIFY `userid` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;
--
-- AUTO_INCREMENT for table `tbl_userlog`
--
ALTER TABLE `tbl_userlog`
  MODIFY `userlogno` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
