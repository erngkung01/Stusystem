...
<head>
<meta charset="utf-8">
<title>ปรับปรุงข้อมูลสมาชิกรายบุคคล</title>
  ...
  <table class="table table-condensed">
    ...
    <tbody>
      ...
      <tr>
       ...
       <tr>
        <td>ชื่อสมาชิก</td>
        <td><input name="user_name" type="text" required="required" class="form-control" id="user_name" placeholder="ใส่ชื่อสมาชิก" value="<?php echo $row_user['user_name']; ?>" ></td>
      </tr>
      </tr>
       <input name="usertypeid" type="hidden" id="usertypeid" value="<?php echo $row_user['usertypeid']; ?>">
     
      <td colspan="2" style="text-align:center;"><input name="inserstudentdata" type="submit" id="inserstudentdata" value="ปรับปรุงข้อมูลสมาชิก" class="btn btn-success" >
        <input name="userid" type="hidden" id="userid" value="<?php echo $row_user['userid']; ?>"></td>
        </tr>
    </tbody>
  </table>
</div>
