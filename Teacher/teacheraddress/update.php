...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "insertstudentaddress")) {
  $updateSQL = sprintf("UPDATE tbl_teacheraddress SET PersonID=%s, HomeID=%s, HouseNo=%s, moo=%s, street=%s, DISTRICT_ID=%s, AMPHUR_ID=%s, PROVINCE_ID=%s, ZipCode=%s WHERE TeacherID=%s",
...
//42320819($database_stusystem, $stusystem);
$query_teacheraddress = sprintf("SELECT * FROM tbl_teacheraddress WHERE TeacherID = %s", GetSQLValueString($colname_teacheraddress, "text"));
...
<div class="container">
 <a href="index.php?TeacherID=<?php echo $row_teacher['TeacherID']; ?>" class="btn btn-primary">กลับไปหน้าข้อมูลที่อยู่อาจารย์</a> 
  ...
  <table class="table table-condensed">
    ...
    <tbody>
      ...
      <tr>
       ...
       <tr>
        <td>รหัสประจำบ้าน</td>
        <td><input name="Homeid" type="text" autofocus required="required" class="form-control" id="Homeid" placeholder="ใส่รหัสประจำบ้าน" value="<?php echo $row_teacheraddress['HomeID']; ?>"></td>
      </tr>
      <tr>
        <td>เลขที่บ้าน</td>
      ...
      <tr>
        <td>หมู่</td>
        <td><input name="moo" type="number" class="form-control" id="moo" placeholder="ใส่หมู่" pattern="[0-9]{1,}" value="<?php echo $row_teacheraddress['moo']; ?>" ></td>
      </tr>
      <tr>
        <td>ถนน</td>
        <td><input name="street" type="text"   class="form-control" id="street" placeholder="ใส่ชื่อถนน" value="<?php echo $row_teacheraddress['street']; ?>"  ></td>
      </tr>
       <tr>
        <td>จังหวัด</td>
        <td><!-- แสดงตัวเลือก จังหวัด -->
						<select  id="province" name="province">
						  <option value="1" <?php if (!(strcmp(1, $row_teacheraddress['PROVINCE_ID']))) {echo "selected=\"selected\"";} ?>>-- กรุณาเลือกจังหวัด --</option>
						  <?php
do {  
?>
						  <option value="<?php echo $row_province['PROVINCE_ID']?>"<?php if (!(strcmp($row_province['PROVINCE_ID'], $row_teacheraddress['PROVINCE_ID']))) {echo "selected=\"selected\"";} ?>><?php echo $row_province['PROVINCE_NAME']?></option>
						  <?php
       ...
       <tr>
        ...
        <td><!-- แสดงตัวเลือก อำเภอ -->
						<select  id="amphur" name="amphur">
						  <option value="1" <?php if (!(strcmp(1, $row_teacheraddress['AMPHUR_ID']))) {echo "selected=\"selected\"";} ?>>-- กรุณาเลือกจังหวัดก่อน --</option>
						  <?php
do {  
?>
						  <option value="<?php echo $row_amphur['AMPHUR_ID']?>"<?php if (!(strcmp($row_amphur['AMPHUR_ID'], $row_teacheraddress['AMPHUR_ID']))) {echo "selected=\"selected\"";} ?>><?php echo $row_amphur['AMPHUR_NAME']?></option>
						  <?php
       ...
       <tr>
        ...
        <td><!-- แสดงตัวเลือก ตำบล -->
						<select  id="district" name="district">
						  <option value="1" <?php if (!(strcmp(1, $row_teacheraddress['DISTRICT_ID']))) {echo "selected=\"selected\"";} ?>>-- กรุณาเลือกอำเภอก่อน --</option>
						  <?php
do {  
?>
						  <option value="<?php echo $row_distic['DISTRICT_ID']?>"<?php if (!(strcmp($row_distic['DISTRICT_ID'], $row_teacheraddress['DISTRICT_ID']))) {echo "selected=\"selected\"";} ?>><?php echo $row_distic['DISTRICT_NAME']?></option>
						  <?php
...
?>
	...
	<script>
      ...
      <tr>
        <td>รหัสไปรษณีย์</td>
        <td><input name="ZipCode" type="text" class="form-control" id="ZipCode" placeholder="ใส่รหัสไปรษณีย์" pattern="[0-9]{1,}" value="<?php echo $row_teacheraddress['ZipCode']; ?>" ></td>
      </tr>
