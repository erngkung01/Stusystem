...
$totalRows_teacheraward = mysqli_num_rows($teacheraward);$colname_teacheraward = "-1";
if (isset($_GET['TeacherID'])) {
  $colname_teacheraward = $_GET['TeacherID'];
}
//42320819($database_stusystem, $stusystem);
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "insertstudentparent")) {
  ...
  $insertSQL = sprintf("INSERT INTO tbl_teacheraward (AwardYear, AwardSemester, AwardName, AwardDetail, AwardPic, AwardDate, AwardBy, TeacherID, AwardTypeID) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<div class="container">
<a href="index.php?TeacherID=<?php echo $row_teacheraward['TeacherID']; ?>" class="btn btn-primary">กลับไปหน้าข้อมูลผลงาน/รางวัลอาจารย์</a>
 <h2 style="text-align:center;">เพิ่มข้อมูลผลงาน/รางวัลอาจารย์</h2>
  ...
  <table class="table table-condensed">
    ...
    <tbody>
      <tr>
        <td>รหัสอาจารย์</td>
        <td><input name="TeacherID" type="text" required="required" class="form-control" id="TeacherID" placeholder="ใส่รหัสนักเรียน เฉพาะตัวเลขเท่านั้น" pattern="[0-9]{1,}" value="<?php echo $row_teacheraward['TeacherID']; ?>" readonly></td>
      </tr>
       <tr>
        <td>ชื่อ</td>
        <td><input name="Teacher_name" type="text" required="required" class="form-control" id="StudentID" placeholder="ใส่ชื่อ" value="<?php echo $row_teacheraward['name']; ?>" readonly></td>
      </tr>
       <tr>
        <td>นามสกุล</td>
        <td><input name="Teacher_surname" type="text" required="required" class="form-control" id="StudentID" placeholder="ใส่นามสกุล" value="<?php echo $row_teacheraward['surname']; ?>"  readonly></td>
      </tr>
      <tr>
      <td>ชื่อผลงานรางวัล</td>
      <td><input name="AwardName" type="text" id="AwardName" class="form-control"></td>
      </tr>
      <tr>
      <td>ปีการศึกษา</td>
...
?>
      ...
      <td>
       ...
       <tr>
      <td>วันที่ได้รับ</td>
       <td> <input type="text" name="AwardDate" id="AwardDate" value=""  class="form-control">&nbsp;</td>
        <!---Datepicker สคริป-->
...
$(function(){
    ...
    $("#AwardDate").on("mouseenter mouseleave",function(e){
      ...
      <td><input name="AwardBy" type="text" id="AwardBy" class="form-control"></td>
      </tr>
       <tr>
...
do {  
?>
        <option value="<?php echo $row_Awardtype['AwardTypeID']?>"><?php echo $row_Awardtype['AwardTypeName']?></option>
        <?php
...
?>
      ...
      <td colspan="2" style="text-align:center;"><input name="inserstudentaward" type="submit" id="inserstudentaward" value="เพิ่มข้อมูลผลงาน/รางวัลอาจารย์" class="btn btn-success" ></td>
        </tr>
    </tbody>
  </table>
</div>
