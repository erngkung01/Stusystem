...
<div class="col-sm-4">
<h1>ค้นหาข้อมูลอาจารย์</h1>
<canvas id="mycanvas"></canvas>
<br>
<button id="btnScan" class="btn btn-primary btn-lg">ค้นหาข้อมูลอาจารย์</button>
...
$("#btnScan").click(function(){
	...
	function dwQRReader(data){
		window.open('<?php echo $web ?>/Teacher/data.php?TeacherID='+data);
		//alert(data);
		}
