...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "insertteacherdata")) {
  ...
  $insertSQL = sprintf("INSERT INTO tbl_teacher (TeacherID, PersonID, PrefixCode, name, surname, Teacher_img, GenderCode, WorkDate, PositionID, tel, email) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
 ...
 //dwthai.com($database_stusystem, $stusystem);
  ...
  $insertGoTo = "teacheraddress/insert.php?TeacherID=".$_POST['TeacherID']."";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="container">
 <a href="index.php" class="btn btn-primary">กลับไปหน้าข้อมูลอาจารย์</a> 
 <h2 style="text-align:center;">เพิ่มข้อมูลอาจารย์</h2>
  ...
  <table class="table table-condensed">
    ...
    <tbody>
      <tr>
        <td>รหัสอาจารย์</td>
        <td><input name="TeacherID" type="text" required="required" class="form-control" id="TeacherID" placeholder="ใส่รหัสอาจารย์ เฉพาะตัวเลขเท่านั้น"pattern="[0-9]{1,}" ></td>
      </tr>
      <tr>
        <td>รหัสประชาชน</td>
        <td><input name="PersonID" type="text" required="required" class="form-control" id="PersonID" placeholder="ใส่รหัสประชาชน เฉพาะตัวเลขเท่านั้น" pattern="[0-9]{1,}" ></td>
      </tr>
...
?>
       ...
       <tr>
        <td>ชื่อ</td>
        <td><input name="name" type="text" required="required" class="form-control" id="name" placeholder="ใส่ชื่ออาจารย์" ></td>
      </tr>
       <tr>
        <td>นามสกุล</td>
        <td><input name="surname" type="text" required="required" class="form-control" id="surname" placeholder="ใส่นามสกุลอาจารย์" ></td>
      </tr>
       <tr>
        <td>รูปภาพ</td>
        <td>
...
?>
      ...
      <td> <input type="text" name="WorkDate" id="WorkDate" value=""  class="form-control">&nbsp;</td>
        <!---Datepicker สคริป-->
...
?>
       ...
       <tr>
        <td>เบอร์โทรศัพท์</td>
        <td><input name="tel" type="text"  class="form-control" id="tel" placeholder="ใส่เบอร์โทรศัพท์" ></td>
      </tr>
       <tr>
        <td>E-mail </td>
        <td><input name="email" type="email"  class="form-control" id="email" placeholder="ใส่ E-mail" ></td>
      </tr>
