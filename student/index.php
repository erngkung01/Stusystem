...
$query_Student = "SELECT a.studentID, a.PersonID, a.PrefixCode, a.student_name, a.student_surname,b.* FROM tbl_student as a,tbl_prefix as b Where  a.PrefixCode=b.PrefixCode ORDER BY a.studentID DESC";
