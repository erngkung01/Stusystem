...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "insertstudentparent")) {
  ...
  $insertSQL = sprintf("INSERT INTO tbl_award (AwardYear, AwardSemester, AwardName, AwardDetail, AwardPic, AwardDate, AwardBy, studentID, AwardTypeID) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<div class="container">
<a href="index.php?studentID=<?php echo $row_studentdata['studentID']; ?>" class="btn btn-primary">กลับไปหน้าข้อมูลผลงาน/รางวัลนักเรียน</a>
 <h2 style="text-align:center;">เพิ่มข้อมูลผลงาน/รางวัลนักเรียน</h2>
...
?>
      ...
      <td colspan="2" style="text-align:center;"><input name="inserstudentaward" type="submit" id="inserstudentaward" value="เพิ่มข้อมูลผลงาน/รางวัลนักเรียน" class="btn btn-success" ></td>
        </tr>
    </tbody>
  </table>
</div>
